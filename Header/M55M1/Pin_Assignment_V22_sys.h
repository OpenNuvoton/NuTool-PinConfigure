...
/**
  ...
  * \hideinitializer
  */
#define SYS_GET_BOD_INT_FLAG()          (SYS->BODCTL & SYS_BODSTS_BODIF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define SYS_GET_BOD_OUTPUT()            (SYS->BODCTL & SYS_BODSTS_BODOUT_Msk)
...
__STATIC_INLINE uint32_t SYS_GetBODStatus(void)
{
    return ((SYS->BODCTL & SYS_BODSTS_BODOUT_Msk) >> SYS_BODSTS_BODOUT_Pos);
}
