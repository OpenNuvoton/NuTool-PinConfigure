...
#define SYS_SRAMPC0_SRAM_LIGHT_SLEEP    (0x1UL) /*!< Select system SRAM power mode to light sleep mode */
#define SYS_SRAMPC0_SRAM_RETENTIOM      (0x2UL) /*!< Select system SRAM power mode to retention mode */
#define SYS_SRAMPC0_SRAM_SHUT_DOWN      (0x3UL) /*!< Select system SRAM power mode to shut down mode */
#define SYS_SRAMPC0_SRAM_LP_RETENTION   (0x6UL) /*!< Select system SRAM power mode to low power retention mode */
#define SYS_SRAMPC0_SRAM_LP_SHUT_DOWN   (0x7UL) /*!< Select system SRAM power mode to low power shut down mode */
