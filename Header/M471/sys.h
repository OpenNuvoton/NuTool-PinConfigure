...
#define SYS_VREFCTL_VREF_2_5V       (0x7UL << SYS_VREFCTL_VREFCTL_Pos)    /*!< Vref = 2.5V \hideinitializer */
#define SYS_VREFCTL_VREF_3_0V       (0xBUL << SYS_VREFCTL_VREFCTL_Pos)    /*!< Vref = 3.0V \hideinitializer */
#define SYS_VREFCTL_VREF_4_0V       (0xFUL << SYS_VREFCTL_VREFCTL_Pos)    /*!< Vref = 4.0V \hideinitializer */
