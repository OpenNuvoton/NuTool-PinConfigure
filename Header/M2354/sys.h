...
#define SET_USB_D_P_PA14()       SYS->GPA_MFPH = (SYS->GPA_MFPH & (~USB_D+_PA14_Msk)) | USB_D_P_PA14             /*!< Set PA14 function to USB_D_P         */
#define SET_USB_D_N_PA13()       SYS->GPA_MFPH = (SYS->GPA_MFPH & (~USB_D-_PA13_Msk)) | USB_D_N_PA13             /*!< Set PA13 function to USB_D_N         */
