...
#define LCD_RST     ((0x8<<24)|SYS_IPRST2_LCDRST_Pos)       /*!< LCD reset is one of the SYS_ResetModule parameter */
#define TK_RST      ((0x8<<24)|SYS_IPRST2_TKRST_Pos)        /*!< TK reset is one of the SYS_ResetModule parameter */
...
#define SYS_GPA_MFPH_PA9MFP_DAC1_OUT     (0x01UL<<SYS_GPA_MFPH_PA9MFP_Pos) /*!< GPA_MFPH PB9 setting for DAC1_OUT    */
...
#define SYS_GPA_MFPH_PA12MFP_LCD_COM4    (0x05UL<<SYS_GPA_MFPH_PA12MFP_Pos) /*!< GPA_MFPH PA12 setting for LCD_COM4   */
#define SYS_GPA_MFPH_PA12MFP_LCD_SEG20   (0x05UL<<SYS_GPA_MFPH_PA12MFP_Pos) /*!< GPA_MFPH PA12 setting for LCD_SEG20  */
#define SYS_GPA_MFPH_PA12MFP_LCD_SEG47   (0x05UL<<SYS_GPA_MFPH_PA12MFP_Pos) /*!< GPA_MFPH PA12 setting for LCD_SEG47  */
...
#define SYS_GPA_MFPH_PA13MFP_LCD_COM5    (0x05UL<<SYS_GPA_MFPH_PA13MFP_Pos) /*!< GPA_MFPH PA13 setting for LCD_COM5   */
#define SYS_GPA_MFPH_PA13MFP_LCD_SEG19   (0x05UL<<SYS_GPA_MFPH_PA13MFP_Pos) /*!< GPA_MFPH PA13 setting for LCD_SEG19  */
#define SYS_GPA_MFPH_PA13MFP_LCD_SEG46   (0x05UL<<SYS_GPA_MFPH_PA13MFP_Pos) /*!< GPA_MFPH PA13 setting for LCD_SEG46  */
...
#define SYS_GPA_MFPH_PA14MFP_LCD_COM6    (0x05UL<<SYS_GPA_MFPH_PA14MFP_Pos) /*!< GPA_MFPH PA14 setting for LCD_COM6   */
#define SYS_GPA_MFPH_PA14MFP_LCD_SEG18   (0x05UL<<SYS_GPA_MFPH_PA14MFP_Pos) /*!< GPA_MFPH PA14 setting for LCD_SEG18  */
#define SYS_GPA_MFPH_PA14MFP_LCD_SEG45   (0x05UL<<SYS_GPA_MFPH_PA14MFP_Pos) /*!< GPA_MFPH PA14 setting for LCD_SEG45  */
...
#define SYS_GPA_MFPH_PA15MFP_LCD_COM7    (0x05UL<<SYS_GPA_MFPH_PA15MFP_Pos) /*!< GPA_MFPH PA15 setting for LCD_COM7   */
#define SYS_GPA_MFPH_PA15MFP_LCD_SEG17   (0x05UL<<SYS_GPA_MFPH_PA15MFP_Pos) /*!< GPA_MFPH PA15 setting for LCD_SEG17  */
#define SYS_GPA_MFPH_PA15MFP_LCD_SEG44   (0x05UL<<SYS_GPA_MFPH_PA15MFP_Pos) /*!< GPA_MFPH PA15 setting for LCD_SEG44  */
...
#define SYS_GPB_MFPL_PB0MFP_LCD_SEG0     (0x05UL<<SYS_GPB_MFPL_PB0MFP_Pos) /*!< GPB_MFPL PB0 setting for LCD_SEG0    */
...
#define SYS_GPB_MFPL_PB6MFP_LCD_SEG4     (0x09UL<<SYS_GPB_MFPL_PB6MFP_Pos) /*!< GPB_MFPL PB6 setting for LCD_SEG4    */
...
#define SYS_GPB_MFPL_PB7MFP_LCD_SEG5     (0x09UL<<SYS_GPB_MFPL_PB7MFP_Pos) /*!< GPB_MFPL PB7 setting for LCD_SEG5    */
...
#define SYS_GPB_MFPH_PB8MFP_LCD_SEG6     (0x08UL<<SYS_GPB_MFPH_PB8MFP_Pos) /*!< GPB_MFPH PB8 setting for LCD_SEG6    */
#define SYS_GPB_MFPH_PB8MFP_LCD_V3       (0x08UL<<SYS_GPB_MFPH_PB8MFP_Pos) /*!< GPB_MFPH PB8 setting for LCD_V3      */
...
#define SYS_GPB_MFPH_PB9MFP_LCD_SEG7     (0x08UL<<SYS_GPB_MFPH_PB9MFP_Pos) /*!< GPB_MFPH PB9 setting for LCD_SEG7    */
#define SYS_GPB_MFPH_PB9MFP_LCD_V2       (0x08UL<<SYS_GPB_MFPH_PB9MFP_Pos) /*!< GPB_MFPH PB9 setting for LCD_V2      */
...
#define SYS_GPB_MFPH_PB10MFP_LCD_SEG8    (0x08UL<<SYS_GPB_MFPH_PB10MFP_Pos) /*!< GPB_MFPH PB10 setting for LCD_SEG8   */
#define SYS_GPB_MFPH_PB10MFP_LCD_V1      (0x08UL<<SYS_GPB_MFPH_PB10MFP_Pos) /*!< GPB_MFPH PB10 setting for LCD_V1     */
...
#define SYS_GPB_MFPH_PB11MFP_LCD_SEG9    (0x08UL<<SYS_GPB_MFPH_PB11MFP_Pos) /*!< GPB_MFPH PB11 setting for LCD_SEG9   */
...
#define SYS_GPC_MFPL_PC5MFP_LCD_SEG31    (0x05UL<<SYS_GPC_MFPL_PC5MFP_Pos) /*!< GPC_MFPL PC5 setting for LCD_SEG31   */
#define SYS_GPC_MFPL_PC5MFP_LCD_COM4     (0x05UL<<SYS_GPC_MFPL_PC5MFP_Pos) /*!< GPC_MFPL PC5 setting for LCD_COM4    */
#define SYS_GPC_MFPL_PC5MFP_TK_TK9       (0x06UL<<SYS_GPC_MFPL_PC5MFP_Pos) /*!< GPC_MFPL PC5 setting for TK_TK9      */
...
#define SYS_GPC_MFPH_PC8MFP_LCD_SEG40    (0x05UL<<SYS_GPC_MFPH_PC8MFP_Pos) /*!< GPC_MFPH PC8 setting for LCD_SEG40   */
#define SYS_GPC_MFPH_PC8MFP_LCD_COM7     (0x05UL<<SYS_GPC_MFPH_PC8MFP_Pos) /*!< GPC_MFPH PC8 setting for LCD_COM7    */
...
#define SYS_GPD_MFPH_PD10MFP_LCD_SEG42   (0x05UL<<SYS_GPD_MFPH_PD10MFP_Pos) /*!< GPD_MFPH PD10 setting for LCD_SEG42  */
#define SYS_GPD_MFPH_PD10MFP_LCD_COM5    (0x05UL<<SYS_GPD_MFPH_PD10MFP_Pos) /*!< GPD_MFPH PD10 setting for LCD_COM5   */
...
#define SYS_GPD_MFPH_PD11MFP_LCD_SEG43   (0x05UL<<SYS_GPD_MFPH_PD11MFP_Pos) /*!< GPD_MFPH PD11 setting for LCD_SEG43  */
#define SYS_GPD_MFPH_PD11MFP_LCD_COM4    (0x05UL<<SYS_GPD_MFPH_PD11MFP_Pos) /*!< GPD_MFPH PD11 setting for LCD_COM4   */
...
#define SYS_GPE_MFPL_PE6MFP_LCD_SEG15    (0x05UL<<SYS_GPE_MFPL_PE6MFP_Pos) /*!< GPE_MFPL PE6 setting for LCD_SEG15   */
...
#define SYS_GPE_MFPL_PE7MFP_LCD_SEG16    (0x05UL<<SYS_GPE_MFPL_PE7MFP_Pos) /*!< GPE_MFPL PE7 setting for LCD_SEG16   */
...
#define SYS_GPE_MFPH_PE8MFP_LCD_SEG20    (0x05UL<<SYS_GPE_MFPH_PE8MFP_Pos) /*!< GPE_MFPH PE8 setting for LCD_SEG20   */
#define SYS_GPE_MFPH_PE8MFP_LCD_COM0     (0x05UL<<SYS_GPE_MFPH_PE8MFP_Pos) /*!< GPE_MFPH PE8 setting for LCD_COM0    */
...
#define SYS_GPE_MFPH_PE9MFP_LCD_SEG19    (0x05UL<<SYS_GPE_MFPH_PE9MFP_Pos) /*!< GPE_MFPH PE9 setting for LCD_SEG19   */
#define SYS_GPE_MFPH_PE9MFP_LCD_COM1     (0x05UL<<SYS_GPE_MFPH_PE9MFP_Pos) /*!< GPE_MFPH PE9 setting for LCD_COM1    */
...
#define SYS_GPE_MFPH_PE13MFP_LCD_SEG41   (0x05UL<<SYS_GPE_MFPH_PE13MFP_Pos) /*!< GPE_MFPH PE13 setting for LCD_SEG41  */
#define SYS_GPE_MFPH_PE13MFP_LCD_COM6    (0x05UL<<SYS_GPE_MFPH_PE13MFP_Pos) /*!< GPE_MFPH PE13 setting for LCD_COM6   */
...
#define SYS_GPE_MFPH_PE14MFP_LCD_SEG34   (0x05UL<<SYS_GPE_MFPH_PE14MFP_Pos) /*!< GPF_MFPH PE14 setting for LCD_SEG34  */
#define SYS_GPE_MFPH_PE14MFP_TK_TK8      (0x06UL<<SYS_GPE_MFPH_PE14MFP_Pos) /*!< GPF_MFPH PE14 setting for TK_TK8     */
