...
NUTOOL_PIN.g_cfg_chips = [
    { name: "N76E003AQ20", pkg: "QFN20" },
    { name: "N76E003BQ20", pkg: "QFN20" },
    { name: "N76E003AT20", pkg: "TSSOP20" }
];
...
NUTOOL_PIN.g_cfg_gpiosDefines = [
    ...
    { f: ['P0.2', 'ICE_CLK:NULL@P0MF76543210', 'UART1_RXD:P01_INPUT_MODE;@P0MF76543210', 'I2C0_SCL:P01_OPENDRAIN_MODE;@P0MF76543210'] },
    ...
    { f: ['P1.7', 'INT1:P17_QUASI_MODE;@P1MF76543210', 'ADC_CH0:ENABLE_ADC_AIN0;@P1MF76543210'] },
...
NUTOOL_PIN.decidepackageNumber = function (given_partNumber_package) {
    ...
    case 'QFN20':
        switch (partNumber) {
        case "N76E003BQ20":
            NUTOOL_PIN.g_packageNumberIndex = "QFN20(N76E003BQ20)";
            break;
        default:
            NUTOOL_PIN.g_packageNumberIndex = "QFN20(N76E003AQ20)";
            break;
        }
        break;
    case 'TSSOP20':
