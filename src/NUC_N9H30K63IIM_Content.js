...
NUTOOL_PIN.g_cfg_pkgs = {
    "LQFP128(14*14)": [
        ...
        'PA.1', 'PA.0', 'ADC6', 'ADC4', 'AVDD', 'ADC7', 'ADC5', 'ADC3', 'RTC_VDD', 'X32_IN', 
        'X32_OUT', 'CORE_VDD', 'PI.1', 'PI.3', 'PI.4', 'PI.5', 'PI.6', 'PI.7', 'PI.8', 'PI.9', 
        'PI.10', 'PI.11', 'PI.12', 'VSS', 'PI.13', 'PI.14', 'PI.15', 'IO_VDD', 'PB.6', 'PB.7', 
        'PB.8', 'PB.9', 'PB.10', 'PB.11', 'PJ.3', 'PJ.0', 'PJ.1', 'PJ.2', 'PJ.4', 'nRESET', 
...
NUTOOL_PIN.g_cfg_gpios = [
    { f: ['PA.0:0', 'PWRON_SET0:2']},
    { f: ['PA.1:0', 'PWRON_SET1:2']},
    { f: ['PA.2:0', 'PWRON_SET2:2']},
    { f: ['PA.3:0', 'PWRON_SET3:2']},
    { f: ['PA.4:0', 'PWRON_SET4:2']},
    { f: ['PA.5:0', 'PWRON_SET5:2']},
    { f: ['PA.6:0', 'PWRON_SET6:2']},
    { f: ['PA.7:0', 'PWRON_SET7:2']},
    { f: ['PA.8:0', 'PWRON_SET8:2']},
    { f: ['PA.9:0', 'PWRON_SET9:2']},
    { f: ['PA.10:0']},
    { f: ['PA.11:0']},
    { f: ['PA.12:0', 'PWM0:2']},
    { f: ['PA.13:0', 'PWM1:2']},
    ...
    { f: ['PD.8:0', 'EBI_nCS0:2']},
    { f: ['PD.9:0', 'EBI_nCS1:2']},
    { f: ['PD.10:0', 'EBI_nCS2:2']},
    { f: ['PD.11:0', 'EBI_nCS3:2', 'UART9_TXD:4']},
    { f: ['PD.12:0', 'EBI_nCS4:2', 'PWM0:3', 'UART9_RXD:4']},
    { f: ['PD.13:0', 'EBI_nWE:2', 'PWM1:3']},
    { f: ['PD.14:0', 'EBI_nOE:2', 'PWM2:3', 'UART9_TXD:4']},
    { f: ['PD.15:0', 'EBI_nWAIT:2', 'PWM3:3', 'UART9_RXD:4']},
    ...
    { f: ['PI.7:0', 'SC1_CLK:1', 'NAND_RDY0:2', 'UART1_RTS:3', 'VCAP_FIELD:4', 'SPI1_DO:5', 'D0:5', 'SD1_DAT0:6', 'eMMC_DATA3:7', 'EBI_DATA7:8']},
    { f: ['PI.8:0', 'SC1_DAT:1', 'NAND_DATA0:2', 'UART1_CTS:3', 'VCAP_DATA0:4', 'SPI1_DI:5', 'D1:5', 'SD1_DAT1:6', 'eMMC_DATA0:7', 'EBI_DATA8:8']},
