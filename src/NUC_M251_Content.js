...
NUTOOL_PIN.g_cfg_pkgs = {
	...
	"UTSSOP20(4.4*6.5)(C_QSPI)": [
		'USB_D-', 'USB_D+', 'USB_VDD33_CAP', 'VSS', 'LDO_CAP',
		'VDD', 'PB.14', 'PB.13', 'PB.12', 'AVDD',
		'PF.3', 'PF.2', 'PA.3', 'PA.2', 'PA.1',
		'PA.0', 'nRESET', 'PF.0', 'PF.1', 'USB_VBUS'
	],
	"TSSOP28(4.4*9.7)(C_QSPI)": [
	...
	"UTSSOP28(4.4*9.7)(C_QSPI)": [
		'USB_VBUS', 'USB_D-', 'USB_D+', 'USB_VDD33_CAP', 'VSS', 'LDO_CAP', 'VDD',
		'PB.14', 'PB.13', 'PB.12', 'AVDD', 'PB.5', 'PB.4', 'PB.3',
		'PB.2', 'PB.1', 'PB.0', 'PF.3', 'PF.2', 'PA.3', 'PA.2',
		'PA.1', 'PA.0', 'nRESET', 'PF.0', 'PF.1', 'PC.1', 'PC.0'
	],
	...
	"LQFP128(14*14)(E_G_QSPI)": [
		'PB.5', 'PB.4', 'PB.3', 'PB.2', 'PC.12', 'PC.11', 'PC.10', 'PC.9', 'PB.1', 'PB.0',
		'VSS', 'VDD', 'PA.11', 'PA.10', 'PA.9', 'PA.8', 'NC', 'PD.12', 'PD.11', 'PD.10',
...
NUTOOL_PIN.g_cfg_gpios = [
	{ f: ['PA.0:0', 'QSPI0_MOSI0:3', 'SPI0_MOSI:4', 'SC0_CLK:6', 'UART0_RXD:7', 'UART1_nRTS:8', 'PSIO0_CH7:10', 'USCI2_DAT1:11', 'BPWM0_CH0:12', 'PWM0_CH5:13', 'DAC0_ST:15']},
	{ f: ['PA.1:0', 'QSPI0_MISO0:3', 'SPI0_MISO:4', 'SC0_DAT:6', 'UART0_TXD:7', 'UART1_nCTS:8', 'PSIO0_CH6:10', 'USCI2_DAT0:11', 'BPWM0_CH1:12', 'PWM0_CH4:13']},
	{ f: ['PA.2:0', 'QSPI0_CLK:3', 'SPI0_CLK:4', 'SC0_RST:6', 'I2C0_SMBSUS:7', 'UART1_RXD:8', 'I2C1_SDA:9', 'PSIO0_CH5:10', 'USCI2_CLK:11', 'BPWM0_CH2:12', 'PWM0_CH3:13']},
	{ f: ['PA.3:0', 'QSPI0_SS:3', 'SPI0_SS:4', 'SC0_PWR:6', 'I2C0_SMBAL:7', 'UART1_TXD:8', 'I2C1_SCL:9', 'PSIO0_CH4:10', 'USCI2_CTL0:11', 'BPWM0_CH3:12', 'PWM0_CH2:13', 'CLKO:14', 'PWM1_BRAKE1:15']},
	{ f: ['PA.4:0', 'QSPI0_MOSI1:3', 'SPI0_I2SMCLK:4', 'SC0_nCD:6', 'UART0_nRTS:7', 'UART0_RXD:8', 'I2C0_SDA:9', 'USCI2_CTL1:11', 'BPWM0_CH4:12', 'PWM0_CH1:13']},
	{ f: ['PA.5:0', 'QSPI0_MISO1:3', 'UART0_nCTS:7', 'UART0_TXD:8', 'I2C0_SCL:9', 'BPWM0_CH5:12', 'PWM0_CH0:13']},
	...
	{ f: ['PA.8:0', 'EBI_ALE:2', 'USCI0_CTL1:6', 'UART1_RXD:7', 'BPWM0_CH3:9', 'TM3_EXT:13', 'INT4:15']},
	{ f: ['PA.9:0', 'EBI_MCLK:2', 'USCI0_DAT1:6', 'UART1_TXD:7', 'BPWM0_CH2:9', 'TM2_EXT:13']},
	{ f: ['PA.10:0', 'ACMP1_P0:1', 'EBI_nWR:2', 'USCI0_DAT0:6', 'BPWM0_CH1:9', 'TM1_EXT:13', 'DAC0_ST:14']},
	{ f: ['PA.11:0', 'ACMP0_P0:1', 'EBI_nRD:2', 'USCI0_CLK:6', 'BPWM0_CH0:9', 'TM0_EXT:13']},
	{ f: ['PA.12:0', 'I2C1_SCL:4', 'USCI2_DAT1:8', 'PSIO0_CH4:10', 'BPWM1_CH2:11']},
	{ f: ['PA.13:0', 'I2C1_SDA:4', 'USCI2_DAT0:8', 'PSIO0_CH5:10', 'BPWM1_CH3:11']},
	{ f: ['PA.14:0', 'UART0_TXD:3', 'USCI2_CLK:8', 'PSIO0_CH6:10', 'BPWM1_CH4:11']},
	{ f: ['PA.15:0', 'UART0_RXD:3', 'USCI2_CTL1:8', 'PSIO0_CH7:10', 'BPWM1_CH5:11']},

	{ f: ['PB.0:0', 'EADC0_CH0:1', 'OPA0_P:1', 'EBI_ADR9:2', 'UART2_RXD:7', 'SPI0_I2SMCLK:8', 'I2C1_SDA:9', 'QSPI0_MOSI1:10', 'PWM0_CH5:11', 'PWM1_CH5:12', 'PWM0_BRAKE1:13']},
	{ f: ['PB.1:0', 'EADC0_CH1:1', 'OPA0_N:1', 'EBI_ADR8:2', 'UART2_TXD:7', 'USCI1_CLK:8', 'I2C1_SCL:9', 'QSPI0_MISO1:10', 'PWM0_CH4:11', 'PWM1_CH4:12', 'PWM0_BRAKE0:13']},
	{ f: ['PB.2:0', 'EADC0_CH2:1', 'ACMP0_P1:1', 'OPA0_O:1', 'EBI_ADR3:2', 'I2C1_SDA:4', 'UART1_RXD:6', 'USCI1_DAT0:8', 'SC0_PWR:9', 'PWM0_CH3:11', 'PSIO0_CH7:12', 'TM3:14', 'INT3:15']},
	{ f: ['PB.3:0', 'EADC0_CH3:1', 'ACMP0_N:1', 'EBI_ADR2:2', 'I2C1_SCL:4', 'UART1_TXD:6', 'USCI1_DAT1:8', 'SC0_RST:9', 'PWM0_CH2:11', 'PSIO0_CH6:12', 'PWM0_BRAKE0:13', 'TM2:14', 'INT2:15']},
	{ f: ['PB.4:0', 'EADC0_CH4:1', 'ACMP1_P1:1', 'EBI_ADR1:2', 'I2C0_SDA:6', 'USCI1_CTL1:8', 'SC0_DAT:9', 'PWM0_CH1:11', 'PSIO0_CH5:12', 'UART2_RXD:13', 'TM1:14', 'INT1:15']},
	{ f: ['PB.5:0', 'EADC0_CH5:1', 'ACMP1_N:1', 'EBI_ADR0:2', 'I2C0_SCL:6', 'USCI1_CTL0:8', 'SC0_CLK:9', 'PWM0_CH0:11', 'PSIO0_CH4:12', 'UART2_TXD:13', 'TM0:14', 'INT0:15']},
	{ f: ['PB.6:0', 'EADC0_CH6:1', 'EBI_nWRH:2', 'USCI1_DAT1:4', 'UART1_RXD:6', 'EBI_nCS1:8', 'BPWM1_CH5:10', 'PWM1_BRAKE1:11', 'PWM1_CH5:12', 'INT4:13', 'ACMP1_O:15']},
	{ f: ['PB.7:0', 'EADC0_CH7:1', 'EBI_nWRL:2', 'USCI1_DAT0:4', 'UART1_TXD:6', 'EBI_nCS0:8', 'BPWM1_CH4:10', 'PWM1_BRAKE0:11', 'PWM1_CH4:12', 'INT5:13', 'ACMP0_O:15']},
	{ f: ['PB.8:0', 'EADC0_CH8:1', 'EBI_ADR19:2', 'USCI1_CLK:4', 'UART0_RXD:5', 'UART1_nRTS:6', 'I2C1_SMBSUS:7', 'BPWM1_CH3:10']},
	{ f: ['PB.9:0', 'EADC0_CH9:1', 'EBI_ADR18:2', 'USCI1_CTL1:4', 'UART0_TXD:5', 'UART1_nCTS:6', 'I2C1_SMBAL:7', 'BPWM1_CH2:10']},
	{ f: ['PB.10:0', 'EADC0_CH10:1', 'EBI_ADR17:2', 'USCI1_CTL0:4', 'UART0_nRTS:5', 'I2C1_SDA:7', 'BPWM1_CH1:10']},
	{ f: ['PB.11:0', 'EADC0_CH11:1', 'EBI_ADR16:2', 'UART0_nCTS:5', 'I2C1_SCL:7', 'SPI0_I2SMCLK:9', 'BPWM1_CH0:10']},
	{ f: ['PB.12:0', 'EADC0_CH12:1', 'DAC0_OUT:1', 'ACMP0_P2:1', 'ACMP1_P2:1', 'EBI_AD15:2', 'SPI0_MOSI:4', 'USCI0_CLK:5', 'UART0_RXD:6', 'PSIO0_CH3:10', 'PWM1_CH3:11', 'TM3_EXT:13']},
	{ f: ['PB.13:0', 'EADC0_CH13:1', 'ACMP0_P3:1', 'ACMP1_P3:1', 'EBI_AD14:2', 'SPI0_MISO:4', 'USCI0_DAT0:5', 'UART0_TXD:6', 'PSIO0_CH2:10', 'PWM1_CH2:11', 'TM2_EXT:13']},
	{ f: ['PB.14:0', 'EADC0_CH14:1', 'EBI_AD13:2', 'SPI0_CLK:4', 'USCI0_DAT1:5', 'UART0_nRTS:6', 'PSIO0_CH1:10', 'PWM1_CH1:11', 'TM1_EXT:13', 'CLKO:14']},
	{ f: ['PB.15:0', 'EADC0_CH15:1', 'EBI_AD12:2', 'SPI0_SS:4', 'USCI0_CTL1:5', 'UART0_nCTS:6', 'PSIO0_CH0:10', 'PWM1_CH0:11', 'TM0_EXT:13', 'PWM0_BRAKE1:15']},

	{ f: ['PC.0:0', 'EBI_AD0:2', 'QSPI0_MOSI0:4', 'UART2_RXD:8', 'I2C0_SDA:9', 'PWM1_CH5:12', 'USCI2_DAT1:13', 'ACMP1_O:14']},
	{ f: ['PC.1:0', 'EBI_AD1:2', 'QSPI0_MISO0:4', 'UART2_TXD:8', 'I2C0_SCL:9', 'PWM1_CH4:12', 'USCI2_DAT0:13', 'ACMP0_O:14']},
	{ f: ['PC.2:0', 'EBI_AD2:2', 'QSPI0_CLK:4', 'UART2_nCTS:8', 'I2C0_SMBSUS:9', 'PWM1_CH3:12', 'USCI2_CLK:13', 'PSIO0_CH3:15']},
	{ f: ['PC.3:0', 'EBI_AD3:2', 'QSPI0_SS:4', 'UART2_nRTS:8', 'I2C0_SMBAL:9', 'PWM1_CH2:12', 'USCI2_CTL0:13', 'PSIO0_CH2:15']},
	{ f: ['PC.4:0', 'EBI_AD4:2', 'QSPI0_MOSI1:4', 'UART2_RXD:8', 'I2C1_SDA:9', 'PWM1_CH1:12', 'USCI2_CTL1:13', 'PSIO0_CH1:15']},
	{ f: ['PC.5:0', 'EBI_AD5:2', 'QSPI0_MISO1:4', 'UART2_TXD:8', 'I2C1_SCL:9', 'PWM1_CH0:12', 'PSIO0_CH0:15']},
	{ f: ['PC.6:0', 'EBI_AD8:2', 'UART0_nRTS:7', 'I2C1_SMBSUS:8', 'PWM1_CH3:11', 'BPWM1_CH1:12', 'TM1:14', 'INT2:15']},
	{ f: ['PC.7:0', 'EBI_AD9:2', 'UART0_nCTS:7', 'I2C1_SMBAL:8', 'PWM1_CH2:11', 'BPWM1_CH0:12', 'TM0:14', 'INT3:15']},
	{ f: ['PC.8:0', 'EBI_ADR16:2', 'I2C0_SDA:4', 'UART1_RXD:8', 'PWM1_CH1:11', 'BPWM1_CH4:12']},
	{ f: ['PC.9:0', 'EBI_ADR7:2', 'PWM1_CH3:12']},
	{ f: ['PC.10:0', 'EBI_ADR6:2', 'PWM1_CH2:12']},
	{ f: ['PC.11:0', 'EBI_ADR5:2', 'UART0_RXD:3', 'I2C0_SDA:4', 'PWM1_CH1:12', 'ACMP1_O:14']},
	{ f: ['PC.12:0', 'EBI_ADR4:2', 'UART0_TXD:3', 'I2C0_SCL:4', 'SC0_nCD:9', 'PWM1_CH0:12', 'ACMP0_O:14']},
	{ f: ['PC.13:0']},
	{ f: ['PC.14:0', 'EBI_AD11:2', 'SPI0_I2SMCLK:4', 'USCI0_CTL0:5', 'QSPI0_CLK:6', 'USCI2_CLK:7', 'TM1:13']},
	{ f: ['PC.15:0']},
	...
	{ f: ['PD.3:0', 'EBI_AD10:2', 'USCI0_CTL1:3', 'SPI0_SS:4', 'USCI1_CTL0:6', 'UART0_TXD:9']},
	{ f: ['PD.4:0', 'USCI0_CTL0:3', 'I2C1_SDA:4', 'USCI1_CTL1:6', 'PSIO0_CH7:10']},
	{ f: ['PD.5:0', 'I2C1_SCL:4', 'USCI1_DAT0:6', 'PSIO0_CH6:10']},
	{ f: ['PD.6:0', 'UART1_RXD:3', 'I2C0_SDA:4', 'USCI1_DAT1:6', 'PSIO0_CH5:10']},
	{ f: ['PD.7:0', 'UART1_TXD:3', 'I2C0_SCL:4', 'USCI1_CLK:6', 'PSIO0_CH4:10']},
	{ f: ['PD.8:0', 'EBI_AD6:2', 'UART2_nRTS:4', 'PSIO0_CH3:10']},
	{ f: ['PD.9:0', 'EBI_AD7:2', 'UART2_nCTS:4', 'PSIO0_CH2:10']},
	{ f: ['PD.10:0', 'EBI_nCS2:2', 'UART1_RXD:3']},
	{ f: ['PD.11:0', 'EBI_nCS1:2', 'UART1_TXD:3']},
	{ f: ['PD.12:0', 'EBI_nCS0:2', 'UART2_RXD:7', 'BPWM0_CH5:9', 'CLKO:13', 'EADC0_ST:14', 'INT5:15']},
	{ f: ['PD.13:0', 'EBI_AD10:2', 'SPI0_I2SMCLK:4', 'USCI2_CTL0:8']},
	{ f: ['PD.14:0']},
	{ f: ['PD.15:0', 'PSIO0_CH7:11', 'PWM0_CH5:12', 'TM3:14', 'INT1:15']},

	{ f: ['PE.0:0', 'EBI_AD11:2', 'QSPI0_MOSI0:3', 'I2C1_SDA:8', 'USCI2_DAT0:10']},
	{ f: ['PE.1:0', 'EBI_AD10:2', 'QSPI0_MISO0:3', 'I2C1_SCL:8', 'USCI2_DAT1:10']},
	{ f: ['PE.2:0', 'EBI_ALE:2', 'SC0_CLK:6', 'USCI0_CLK:7', 'USCI2_CTL0:10', 'PWM0_CH5:12', 'BPWM0_CH0:13']},
	{ f: ['PE.3:0', 'EBI_MCLK:2', 'SC0_DAT:6', 'USCI0_DAT0:7', 'PWM0_CH4:12', 'BPWM0_CH1:13']},
	{ f: ['PE.4:0', 'EBI_nWR:2', 'SC0_RST:6', 'USCI0_DAT1:7', 'PSIO0_CH3:10', 'PWM0_CH3:12', 'BPWM0_CH2:13']},
	{ f: ['PE.5:0', 'EBI_nRD:2', 'SC0_PWR:6', 'USCI0_CTL1:7', 'PSIO0_CH2:10', 'PWM0_CH2:12', 'BPWM0_CH3:13']},
	{ f: ['PE.6:0', 'SC0_nCD:6', 'USCI0_CTL0:7', 'PSIO0_CH1:10', 'PWM0_CH1:12', 'BPWM0_CH4:13']},
	{ f: ['PE.7:0', 'PSIO0_CH0:10', 'PWM0_CH0:12', 'BPWM0_CH5:13']},
	...
	{ f: ['PE.10:0', 'EBI_ADR12:2', 'USCI1_DAT0:6', 'PWM0_CH2:10', 'PWM1_BRAKE0:11']},
	{ f: ['PE.11:0', 'EBI_ADR13:2', 'USCI1_DAT1:6', 'UART1_nCTS:8', 'PWM0_CH3:10', 'PWM1_BRAKE1:11']},
	{ f: ['PE.12:0', 'EBI_ADR14:2', 'USCI1_CLK:6', 'UART1_nRTS:8', 'PWM0_CH4:10']},
	{ f: ['PE.13:0', 'EBI_ADR15:2', 'I2C0_SCL:4', 'UART1_TXD:8', 'PWM0_CH5:10', 'PWM1_CH0:11', 'BPWM1_CH5:12']},
	{ f: ['PE.14:0', 'EBI_AD8:2', 'UART2_TXD:3', 'PSIO0_CH0:10']},
	{ f: ['PE.15:0', 'EBI_AD9:2', 'UART2_RXD:3', 'PSIO0_CH1:10']},
	...
	{ f: ['PF.5:0', 'UART2_RXD:2', 'UART2_nCTS:4', 'PWM0_CH0:7', 'BPWM0_CH4:8', 'X32_IN:10', 'EADC0_ST:11']},
	{ f: ['PF.6:0', 'EBI_ADR19:2', 'SC0_CLK:3', 'SPI0_MOSI:5', 'EBI_nCS0:7', 'TAMPER0:10']},
	{ f: ['PF.7:0', 'EBI_ADR18:2', 'SC0_DAT:3', 'SPI0_MISO:5']},
	{ f: ['PF.8:0']},
	{ f: ['PF.9:0']},
	{ f: ['PF.10:0']},
	{ f: ['PF.11:0']},
	{ f: ['PF.12:0']},
	{ f: ['PF.13:0']},
	{ f: ['PF.14:0', 'PWM1_BRAKE0:9', 'PWM0_BRAKE0:10', 'PSIO0_CH3:11', 'PWM0_CH4:12', 'CLKO:13', 'TM3:14', 'INT5:15']},
	{ f: ['PF.15:0']}
];
...
NUTOOL_PIN.g_cfg_gpiosDefines = [
	...
	{ f: ['PA.3', 'GPIO:SYS_GPA_MFPL_PA3MFP_GPIO@GPA_MFPL', 'QSPI0_SS:SYS_GPA_MFPL_PA3MFP_QSPI0_SS@GPA_MFPL', 'SPI0_SS:SYS_GPA_MFPL_PA3MFP_SPI0_SS@GPA_MFPL', 'SC0_PWR:SYS_GPA_MFPL_PA3MFP_SC0_PWR@GPA_MFPL', 'I2C0_SMBAL:SYS_GPA_MFPL_PA3MFP_I2C0_SMBAL@GPA_MFPL', 'UART1_TXD:SYS_GPA_MFPL_PA3MFP_UART1_TXD@GPA_MFPL', 'I2C1_SCL:SYS_GPA_MFPL_PA3MFP_I2C1_SCL@GPA_MFPL', 'PSIO0_CH4:SYS_GPA_MFPL_PA3MFP_PSIO0_CH4@GPA_MFPL', 'USCI2_CTL0:SYS_GPA_MFPL_PA3MFP_USCI2_CTL0@GPA_MFPL', 'BPWM0_CH3:SYS_GPA_MFPL_PA3MFP_BPWM0_CH3@GPA_MFPL', 'PWM0_CH2:SYS_GPA_MFPL_PA3MFP_PWM0_CH2@GPA_MFPL', 'PWM1_BRAKE1:SYS_GPA_MFPL_PA3MFP_PWM1_BRAKE1@GPA_MFPL', 'CLKO:SYS_GPA_MFPL_PA3MFP_CLKO@GPA_MFPL'] },
	...
	{ f: ['PA.11', 'GPIO:SYS_GPA_MFPH_PA11MFP_GPIO@GPA_MFPH', 'ACMP0_P0:SYS_GPA_MFPH_PA11MFP_ACMP0_P0@GPA_MFPH', 'EBI_nRD:SYS_GPA_MFPH_PA11MFP_EBI_nRD@GPA_MFPH', 'USCI0_CLK:SYS_GPA_MFPH_PA11MFP_USCI0_CLK@GPA_MFPH', 'BPWM0_CH0:SYS_GPA_MFPH_PA11MFP_BPWM0_CH0@GPA_MFPH', 'TM0_EXT:SYS_GPA_MFPH_PA11MFP_TM0_EXT@GPA_MFPH'] },
	{ f: ['PA.12', 'GPIO:SYS_GPA_MFPH_PA12MFP_GPIO@GPA_MFPH', 'I2C1_SCL:SYS_GPA_MFPH_PA12MFP_I2C1_SCL@GPA_MFPH', 'USCI2_DAT1:SYS_GPA_MFPH_PA12MFP_USCI2_DAT1@GPA_MFPH', 'PSIO0_CH4:SYS_GPA_MFPH_PA12MFP_PSIO0_CH4@GPA_MFPH', 'BPWM1_CH2:SYS_GPA_MFPH_PA12MFP_BPWM1_CH2@GPA_MFPH'] },
	{ f: ['PA.13', 'GPIO:SYS_GPA_MFPH_PA13MFP_GPIO@GPA_MFPH', 'I2C1_SDA:SYS_GPA_MFPH_PA13MFP_I2C1_SDA@GPA_MFPH', 'USCI2_DAT0:SYS_GPA_MFPH_PA13MFP_USCI2_DAT0@GPA_MFPH', 'PSIO0_CH5:SYS_GPA_MFPH_PA13MFP_PSIO0_CH5@GPA_MFPH', 'BPWM1_CH3:SYS_GPA_MFPH_PA13MFP_BPWM1_CH3@GPA_MFPH'] },
	{ f: ['PA.14', 'GPIO:SYS_GPA_MFPH_PA14MFP_GPIO@GPA_MFPH', 'UART0_TXD:SYS_GPA_MFPH_PA14MFP_UART0_TXD@GPA_MFPH', 'USCI2_CLK:SYS_GPA_MFPH_PA14MFP_USCI2_CLK@GPA_MFPH', 'PSIO0_CH6:SYS_GPA_MFPH_PA14MFP_PSIO0_CH6@GPA_MFPH', 'BPWM1_CH4:SYS_GPA_MFPH_PA14MFP_BPWM1_CH4@GPA_MFPH'] },
	{ f: ['PA.15', 'GPIO:SYS_GPA_MFPH_PA15MFP_GPIO@GPA_MFPH', 'UART0_RXD:SYS_GPA_MFPH_PA15MFP_UART0_RXD@GPA_MFPH', 'USCI2_CTL1:SYS_GPA_MFPH_PA15MFP_USCI2_CTL1@GPA_MFPH', 'PSIO0_CH7:SYS_GPA_MFPH_PA15MFP_PSIO0_CH7@GPA_MFPH', 'BPWM1_CH5:SYS_GPA_MFPH_PA15MFP_BPWM1_CH5@GPA_MFPH'] },

	{ f: ['PB.0', 'GPIO:SYS_GPB_MFPL_PB0MFP_GPIO@GPB_MFPL', 'EADC0_CH0:SYS_GPB_MFPL_PB0MFP_EADC0_CH0@GPB_MFPL', 'OPA0_P:SYS_GPB_MFPL_PB0MFP_OPA0_P@GPB_MFPL', 'EBI_ADR9:SYS_GPB_MFPL_PB0MFP_EBI_ADR9@GPB_MFPL', 'UART2_RXD:SYS_GPB_MFPL_PB0MFP_UART2_RXD@GPB_MFPL', 'SPI0_I2SMCLK:SYS_GPB_MFPL_PB0MFP_SPI0_I2SMCLK@GPB_MFPL', 'I2C1_SDA:SYS_GPB_MFPL_PB0MFP_I2C1_SDA@GPB_MFPL', 'QSPI0_MOSI1:SYS_GPB_MFPL_PB0MFP_QSPI0_MOSI1@GPB_MFPL', 'PWM0_CH5:SYS_GPB_MFPL_PB0MFP_PWM0_CH5@GPB_MFPL', 'PWM1_CH5:SYS_GPB_MFPL_PB0MFP_PWM1_CH5@GPB_MFPL', 'PWM0_BRAKE1:SYS_GPB_MFPL_PB0MFP_PWM0_BRAKE1@GPB_MFPL'] },
	{ f: ['PB.1', 'GPIO:SYS_GPB_MFPL_PB1MFP_GPIO@GPB_MFPL', 'EADC0_CH1:SYS_GPB_MFPL_PB1MFP_EADC0_CH1@GPB_MFPL', 'OPA0_N:SYS_GPB_MFPL_PB1MFP_OPA0_N@GPB_MFPL', 'EBI_ADR8:SYS_GPB_MFPL_PB1MFP_EBI_ADR8@GPB_MFPL', 'UART2_TXD:SYS_GPB_MFPL_PB1MFP_UART2_TXD@GPB_MFPL', 'USCI1_CLK:SYS_GPB_MFPL_PB1MFP_USCI1_CLK@GPB_MFPL', 'I2C1_SCL:SYS_GPB_MFPL_PB1MFP_I2C1_SCL@GPB_MFPL', 'QSPI0_MISO1:SYS_GPB_MFPL_PB1MFP_QSPI0_MISO1@GPB_MFPL', 'PWM0_CH4:SYS_GPB_MFPL_PB1MFP_PWM0_CH4@GPB_MFPL', 'PWM1_CH4:SYS_GPB_MFPL_PB1MFP_PWM1_CH4@GPB_MFPL', 'PWM0_BRAKE0:SYS_GPB_MFPL_PB1MFP_PWM0_BRAKE0@GPB_MFPL'] },
	{ f: ['PB.2', 'GPIO:SYS_GPB_MFPL_PB2MFP_GPIO@GPB_MFPL', 'EADC0_CH2:SYS_GPB_MFPL_PB2MFP_EADC0_CH2@GPB_MFPL', 'ACMP0_P1:SYS_GPB_MFPL_PB2MFP_ACMP0_P1@GPB_MFPL', 'OPA0_O:SYS_GPB_MFPL_PB2MFP_OPA0_O@GPB_MFPL', 'EBI_ADR3:SYS_GPB_MFPL_PB2MFP_EBI_ADR3@GPB_MFPL', 'UART1_RXD:SYS_GPB_MFPL_PB2MFP_UART1_RXD@GPB_MFPL', 'USCI1_DAT0:SYS_GPB_MFPL_PB2MFP_USCI1_DAT0@GPB_MFPL', 'SC0_PWR:SYS_GPB_MFPL_PB2MFP_SC0_PWR@GPB_MFPL', 'PWM0_CH3:SYS_GPB_MFPL_PB2MFP_PWM0_CH3@GPB_MFPL', 'PSIO0_CH7:SYS_GPB_MFPL_PB2MFP_PSIO0_CH7@GPB_MFPL', 'TM3:SYS_GPB_MFPL_PB2MFP_TM3@GPB_MFPL', 'INT3:SYS_GPB_MFPL_PB2MFP_INT3@GPB_MFPL', 'I2C1_SDA:SYS_GPB_MFPL_PB2MFP_I2C1_SDA@GPB_MFPL'] },
	{ f: ['PB.3', 'GPIO:SYS_GPB_MFPL_PB3MFP_GPIO@GPB_MFPL', 'EADC0_CH3:SYS_GPB_MFPL_PB3MFP_EADC0_CH3@GPB_MFPL', 'ACMP0_N:SYS_GPB_MFPL_PB3MFP_ACMP0_N@GPB_MFPL', 'EBI_ADR2:SYS_GPB_MFPL_PB3MFP_EBI_ADR2@GPB_MFPL', 'UART1_TXD:SYS_GPB_MFPL_PB3MFP_UART1_TXD@GPB_MFPL', 'USCI1_DAT1:SYS_GPB_MFPL_PB3MFP_USCI1_DAT1@GPB_MFPL', 'SC0_RST:SYS_GPB_MFPL_PB3MFP_SC0_RST@GPB_MFPL', 'PWM0_CH2:SYS_GPB_MFPL_PB3MFP_PWM0_CH2@GPB_MFPL', 'PSIO0_CH6:SYS_GPB_MFPL_PB3MFP_PSIO0_CH6@GPB_MFPL', 'TM2:SYS_GPB_MFPL_PB3MFP_TM2@GPB_MFPL', 'INT2:SYS_GPB_MFPL_PB3MFP_INT2@GPB_MFPL', 'I2C1_SCL:SYS_GPB_MFPL_PB3MFP_I2C1_SCL@GPB_MFPL', 'PWM0_BRAKE0:SYS_GPB_MFPL_PB3MFP_PWM0_BRAKE0@GPB_MFPL'] },
	{ f: ['PB.4', 'GPIO:SYS_GPB_MFPL_PB4MFP_GPIO@GPB_MFPL', 'EADC0_CH4:SYS_GPB_MFPL_PB4MFP_EADC0_CH4@GPB_MFPL', 'ACMP1_P1:SYS_GPB_MFPL_PB4MFP_ACMP1_P1@GPB_MFPL', 'EBI_ADR1:SYS_GPB_MFPL_PB4MFP_EBI_ADR1@GPB_MFPL', 'I2C0_SDA:SYS_GPB_MFPL_PB4MFP_I2C0_SDA@GPB_MFPL', 'USCI1_CTL1:SYS_GPB_MFPL_PB4MFP_USCI1_CTL1@GPB_MFPL', 'SC0_DAT:SYS_GPB_MFPL_PB4MFP_SC0_DAT@GPB_MFPL', 'PWM0_CH1:SYS_GPB_MFPL_PB4MFP_PWM0_CH1@GPB_MFPL', 'PSIO0_CH5:SYS_GPB_MFPL_PB4MFP_PSIO0_CH5@GPB_MFPL', 'TM1:SYS_GPB_MFPL_PB4MFP_TM1@GPB_MFPL', 'INT1:SYS_GPB_MFPL_PB4MFP_INT1@GPB_MFPL', 'UART2_RXD:SYS_GPB_MFPL_PB4MFP_UART2_RXD@GPB_MFPL'] },
	{ f: ['PB.5', 'GPIO:SYS_GPB_MFPL_PB5MFP_GPIO@GPB_MFPL', 'EADC0_CH5:SYS_GPB_MFPL_PB5MFP_EADC0_CH5@GPB_MFPL', 'ACMP1_N:SYS_GPB_MFPL_PB5MFP_ACMP1_N@GPB_MFPL', 'EBI_ADR0:SYS_GPB_MFPL_PB5MFP_EBI_ADR0@GPB_MFPL', 'I2C0_SCL:SYS_GPB_MFPL_PB5MFP_I2C0_SCL@GPB_MFPL', 'USCI1_CTL0:SYS_GPB_MFPL_PB5MFP_USCI1_CTL0@GPB_MFPL', 'SC0_CLK:SYS_GPB_MFPL_PB5MFP_SC0_CLK@GPB_MFPL', 'PWM0_CH0:SYS_GPB_MFPL_PB5MFP_PWM0_CH0@GPB_MFPL', 'PSIO0_CH4:SYS_GPB_MFPL_PB5MFP_PSIO0_CH4@GPB_MFPL', 'TM0:SYS_GPB_MFPL_PB5MFP_TM0@GPB_MFPL', 'INT0:SYS_GPB_MFPL_PB5MFP_INT0@GPB_MFPL', 'UART2_TXD:SYS_GPB_MFPL_PB5MFP_UART2_TXD@GPB_MFPL'] },
	...
	{ f: ['PC.1', 'GPIO:SYS_GPC_MFPL_PC1MFP_GPIO@GPC_MFPL', 'EBI_AD1:SYS_GPC_MFPL_PC1MFP_EBI_AD1@GPC_MFPL', 'QSPI0_MISO0:SYS_GPC_MFPL_PC1MFP_QSPI0_MISO0@GPC_MFPL', 'UART2_TXD:SYS_GPC_MFPL_PC1MFP_UART2_TXD@GPC_MFPL', 'I2C0_SCL:SYS_GPC_MFPL_PC1MFP_I2C0_SCL@GPC_MFPL', 'PWM1_CH4:SYS_GPC_MFPL_PC1MFP_PWM1_CH4@GPC_MFPL', 'USCI2_DAT0:SYS_GPC_MFPL_PC1MFP_USCI2_DAT0@GPC_MFPL', 'ACMP0_O:SYS_GPC_MFPL_PC1MFP_ACMP0_O@GPC_MFPL'] },
	{ f: ['PC.2', 'GPIO:SYS_GPC_MFPL_PC2MFP_GPIO@GPC_MFPL', 'EBI_AD2:SYS_GPC_MFPL_PC2MFP_EBI_AD2@GPC_MFPL', 'QSPI0_CLK:SYS_GPC_MFPL_PC2MFP_QSPI0_CLK@GPC_MFPL', 'UART2_nCTS:SYS_GPC_MFPL_PC2MFP_UART2_nCTS@GPC_MFPL', 'I2C0_SMBSUS:SYS_GPC_MFPL_PC2MFP_I2C0_SMBSUS@GPC_MFPL', 'PWM1_CH3:SYS_GPC_MFPL_PC2MFP_PWM1_CH3@GPC_MFPL', 'USCI2_CLK:SYS_GPC_MFPL_PC2MFP_USCI2_CLK@GPC_MFPL', 'PSIO0_CH3:SYS_GPC_MFPL_PC2MFP_PSIO0_CH3@GPC_MFPL'] },
	{ f: ['PC.3', 'GPIO:SYS_GPC_MFPL_PC3MFP_GPIO@GPC_MFPL', 'EBI_AD3:SYS_GPC_MFPL_PC3MFP_EBI_AD3@GPC_MFPL', 'QSPI0_SS:SYS_GPC_MFPL_PC3MFP_QSPI0_SS@GPC_MFPL', 'UART2_nRTS:SYS_GPC_MFPL_PC3MFP_UART2_nRTS@GPC_MFPL', 'I2C0_SMBAL:SYS_GPC_MFPL_PC3MFP_I2C0_SMBAL@GPC_MFPL', 'PWM1_CH2:SYS_GPC_MFPL_PC3MFP_PWM1_CH2@GPC_MFPL', 'USCI2_CTL0:SYS_GPC_MFPL_PC3MFP_USCI2_CTL0@GPC_MFPL', 'PSIO0_CH2:SYS_GPC_MFPL_PC3MFP_PSIO0_CH2@GPC_MFPL'] },
	...
	{ f: ['PC.6', 'GPIO:SYS_GPC_MFPL_PC6MFP_GPIO@GPC_MFPL', 'EBI_AD8:SYS_GPC_MFPL_PC6MFP_EBI_AD8@GPC_MFPL', 'UART0_nRTS:SYS_GPC_MFPL_PC6MFP_UART0_nRTS@GPC_MFPL', 'I2C1_SMBSUS:SYS_GPC_MFPL_PC6MFP_I2C1_SMBSUS@GPC_MFPL', 'PWM1_CH3:SYS_GPC_MFPL_PC6MFP_PWM1_CH3@GPC_MFPL', 'BPWM1_CH1:SYS_GPC_MFPL_PC6MFP_BPWM1_CH1@GPC_MFPL', 'TM1:SYS_GPC_MFPL_PC6MFP_TM1@GPC_MFPL', 'INT2:SYS_GPC_MFPL_PC6MFP_INT2@GPC_MFPL'] },
	{ f: ['PC.7', 'GPIO:SYS_GPC_MFPL_PC7MFP_GPIO@GPC_MFPL', 'EBI_AD9:SYS_GPC_MFPL_PC7MFP_EBI_AD9@GPC_MFPL', 'UART0_nCTS:SYS_GPC_MFPL_PC7MFP_UART0_nCTS@GPC_MFPL', 'I2C1_SMBAL:SYS_GPC_MFPL_PC7MFP_I2C1_SMBAL@GPC_MFPL', 'PWM1_CH2:SYS_GPC_MFPL_PC7MFP_PWM1_CH2@GPC_MFPL', 'BPWM1_CH0:SYS_GPC_MFPL_PC7MFP_BPWM1_CH0@GPC_MFPL', 'TM0:SYS_GPC_MFPL_PC7MFP_TM0@GPC_MFPL', 'INT3:SYS_GPC_MFPL_PC7MFP_INT3@GPC_MFPL'] },
	{ f: ['PC.8', 'GPIO:SYS_GPC_MFPH_PC8MFP_GPIO@GPC_MFPH', 'EBI_ADR16:SYS_GPC_MFPH_PC8MFP_EBI_ADR16@GPC_MFPH', 'I2C0_SDA:SYS_GPC_MFPH_PC8MFP_I2C0_SDA@GPC_MFPH', 'UART1_RXD:SYS_GPC_MFPH_PC8MFP_UART1_RXD@GPC_MFPH', 'PWM1_CH1:SYS_GPC_MFPH_PC8MFP_PWM1_CH1@GPC_MFPH', 'BPWM1_CH4:SYS_GPC_MFPH_PC8MFP_BPWM1_CH4@GPC_MFPH'] },
	{ f: ['PC.9', 'GPIO:SYS_GPC_MFPH_PC9MFP_GPIO@GPC_MFPH', 'EBI_ADR7:SYS_GPC_MFPH_PC9MFP_EBI_ADR7@GPC_MFPH', 'PWM1_CH3:SYS_GPC_MFPH_PC9MFP_PWM1_CH3@GPC_MFPH'] },
	{ f: ['PC.10', 'GPIO:SYS_GPC_MFPH_PC10MFP_GPIO@GPC_MFPH', 'EBI_ADR6:SYS_GPC_MFPH_PC10MFP_EBI_ADR6@GPC_MFPH', 'PWM1_CH2:SYS_GPC_MFPH_PC10MFP_PWM1_CH2@GPC_MFPH'] },
	...
	{ f: ['PC.14', 'GPIO:SYS_GPC_MFPH_PC14MFP_GPIO@GPC_MFPH', 'EBI_AD11:SYS_GPC_MFPH_PC14MFP_EBI_AD11@GPC_MFPH', 'SPI0_I2SMCLK:SYS_GPC_MFPH_PC14MFP_SPI0_I2SMCLK@GPC_MFPH', 'USCI0_CTL0:SYS_GPC_MFPH_PC14MFP_USCI0_CTL0@GPC_MFPH', 'QSPI0_CLK:SYS_GPC_MFPH_PC14MFP_QSPI0_CLK@GPC_MFPH', 'USCI2_CLK:SYS_GPC_MFPH_PC14MFP_USCI2_CLK@GPC_MFPH', 'TM1:SYS_GPC_MFPH_PC14MFP_TM1@GPC_MFPH'] },
	...
	{ f: ['PD.3', 'GPIO:SYS_GPD_MFPL_PD3MFP_GPIO@GPD_MFPL', 'EBI_AD10:SYS_GPD_MFPL_PD3MFP_EBI_AD10@GPD_MFPL', 'USCI0_CTL1:SYS_GPD_MFPL_PD3MFP_USCI0_CTL1@GPD_MFPL', 'SPI0_SS:SYS_GPD_MFPL_PD3MFP_SPI0_SS@GPD_MFPL', 'USCI1_CTL0:SYS_GPD_MFPL_PD3MFP_USCI1_CTL0@GPD_MFPL', 'UART0_TXD:SYS_GPD_MFPL_PD3MFP_UART0_TXD@GPD_MFPL'] },
	{ f: ['PD.4', 'GPIO:SYS_GPD_MFPL_PD4MFP_GPIO@GPD_MFPL', 'USCI0_CTL0:SYS_GPD_MFPL_PD4MFP_USCI0_CTL0@GPD_MFPL', 'I2C1_SDA:SYS_GPD_MFPL_PD4MFP_I2C1_SDA@GPD_MFPL', 'USCI1_CTL1:SYS_GPD_MFPL_PD4MFP_USCI1_CTL1@GPD_MFPL', 'PSIO0_CH7:SYS_GPD_MFPL_PD4MFP_PSIO0_CH7@GPD_MFPL'] },
	{ f: ['PD.5', 'GPIO:SYS_GPD_MFPL_PD5MFP_GPIO@GPD_MFPL', 'I2C1_SCL:SYS_GPD_MFPL_PD5MFP_I2C1_SCL@GPD_MFPL', 'USCI1_DAT0:SYS_GPD_MFPL_PD5MFP_USCI1_DAT0@GPD_MFPL', 'PSIO0_CH6:SYS_GPD_MFPL_PD5MFP_PSIO0_CH6@GPD_MFPL'] },
	{ f: ['PD.6', 'GPIO:SYS_GPD_MFPL_PD6MFP_GPIO@GPD_MFPL', 'UART1_RXD:SYS_GPD_MFPL_PD6MFP_UART1_RXD@GPD_MFPL', 'I2C0_SDA:SYS_GPD_MFPL_PD6MFP_I2C0_SDA@GPD_MFPL', 'USCI1_DAT1:SYS_GPD_MFPL_PD6MFP_USCI1_DAT1@GPD_MFPL', 'PSIO0_CH5:SYS_GPD_MFPL_PD6MFP_PSIO0_CH5@GPD_MFPL'] },
	{ f: ['PD.7', 'GPIO:SYS_GPD_MFPL_PD7MFP_GPIO@GPD_MFPL', 'UART1_TXD:SYS_GPD_MFPL_PD7MFP_UART1_TXD@GPD_MFPL', 'I2C0_SCL:SYS_GPD_MFPL_PD7MFP_I2C0_SCL@GPD_MFPL', 'USCI1_CLK:SYS_GPD_MFPL_PD7MFP_USCI1_CLK@GPD_MFPL', 'PSIO0_CH4:SYS_GPD_MFPL_PD7MFP_PSIO0_CH4@GPD_MFPL'] },
	{ f: ['PD.8', 'GPIO:SYS_GPD_MFPH_PD8MFP_GPIO@GPD_MFPH', 'EBI_AD6:SYS_GPD_MFPH_PD8MFP_EBI_AD6@GPD_MFPH', 'UART2_nRTS:SYS_GPD_MFPH_PD8MFP_UART2_nRTS@GPD_MFPH', 'PSIO0_CH3:SYS_GPD_MFPH_PD8MFP_PSIO0_CH3@GPD_MFPH'] },
	{ f: ['PD.9', 'GPIO:SYS_GPD_MFPH_PD9MFP_GPIO@GPD_MFPH', 'EBI_AD7:SYS_GPD_MFPH_PD9MFP_EBI_AD7@GPD_MFPH', 'UART2_nCTS:SYS_GPD_MFPH_PD9MFP_UART2_nCTS@GPD_MFPH', 'PSIO0_CH2:SYS_GPD_MFPH_PD9MFP_PSIO0_CH2@GPD_MFPH'] },
	...
	{ f: ['PD.13', 'GPIO:SYS_GPD_MFPH_PD13MFP_GPIO@GPD_MFPH', 'EBI_AD10:SYS_GPD_MFPH_PD13MFP_EBI_AD10@GPD_MFPH', 'SPI0_I2SMCLK:SYS_GPD_MFPH_PD13MFP_SPI0_I2SMCLK@GPD_MFPH', 'USCI2_CTL0:SYS_GPD_MFPH_PD13MFP_USCI2_CTL0@GPD_MFPH'] },
	{ f: ['PD.14', 'GPIO:SYS_GPD_MFPH_PD14MFP_GPIO@GPD_MFPH'] },
	{ f: ['PD.15', 'GPIO:SYS_GPD_MFPH_PD15MFP_GPIO@GPD_MFPH', 'PSIO0_CH7:SYS_GPD_MFPH_PD15MFP_PSIO0_CH7@GPD_MFPH', 'PWM0_CH5:SYS_GPD_MFPH_PD15MFP_PWM0_CH5@GPD_MFPH', 'TM3:SYS_GPD_MFPH_PD15MFP_TM3@GPD_MFPH', 'INT1:SYS_GPD_MFPH_PD15MFP_INT1@GPD_MFPH'] },

	{ f: ['PE.0', 'GPIO:SYS_GPE_MFPL_PE0MFP_GPIO@GPE_MFPL', 'EBI_AD11:SYS_GPE_MFPL_PE0MFP_EBI_AD11@GPE_MFPL', 'QSPI0_MOSI0:SYS_GPE_MFPL_PE0MFP_QSPI0_MOSI0@GPE_MFPL', 'I2C1_SDA:SYS_GPE_MFPL_PE0MFP_I2C1_SDA@GPE_MFPL', 'USCI2_DAT0:SYS_GPE_MFPL_PE0MFP_USCI2_DAT0@GPE_MFPL'] },
	{ f: ['PE.1', 'GPIO:SYS_GPE_MFPL_PE1MFP_GPIO@GPE_MFPL', 'EBI_AD10:SYS_GPE_MFPL_PE1MFP_EBI_AD10@GPE_MFPL', 'QSPI0_MISO0:SYS_GPE_MFPL_PE1MFP_QSPI0_MISO0@GPE_MFPL', 'I2C1_SCL:SYS_GPE_MFPL_PE1MFP_I2C1_SCL@GPE_MFPL', 'USCI2_DAT1:SYS_GPE_MFPL_PE1MFP_USCI2_DAT1@GPE_MFPL'] },
	...
	{ f: ['PE.6', 'GPIO:SYS_GPE_MFPL_PE6MFP_GPIO@GPE_MFPL', 'SC0_nCD:SYS_GPE_MFPL_PE6MFP_SC0_nCD@GPE_MFPL', 'USCI0_CTL0:SYS_GPE_MFPL_PE6MFP_USCI0_CTL0@GPE_MFPL', 'PSIO0_CH1:SYS_GPE_MFPL_PE6MFP_PSIO0_CH1@GPE_MFPL', 'PWM0_CH1:SYS_GPE_MFPL_PE6MFP_PWM0_CH1@GPE_MFPL', 'BPWM0_CH4:SYS_GPE_MFPL_PE6MFP_BPWM0_CH4@GPE_MFPL'] },
	{ f: ['PE.7', 'GPIO:SYS_GPE_MFPL_PE7MFP_GPIO@GPE_MFPL', 'PSIO0_CH0:SYS_GPE_MFPL_PE7MFP_PSIO0_CH0@GPE_MFPL', 'PWM0_CH0:SYS_GPE_MFPL_PE7MFP_PWM0_CH0@GPE_MFPL', 'BPWM0_CH5:SYS_GPE_MFPL_PE7MFP_BPWM0_CH5@GPE_MFPL'] },
	...
	{ f: ['PE.10', 'GPIO:SYS_GPE_MFPH_PE10MFP_GPIO@GPE_MFPH', 'EBI_ADR12:SYS_GPE_MFPH_PE10MFP_EBI_ADR12@GPE_MFPH', 'USCI1_DAT0:SYS_GPE_MFPH_PE10MFP_USCI1_DAT0@GPE_MFPH', 'PWM0_CH2:SYS_GPE_MFPH_PE10MFP_PWM0_CH2@GPE_MFPH', 'PWM1_BRAKE0:SYS_GPE_MFPH_PE10MFP_PWM1_BRAKE0@GPE_MFPH'] },
	...
	{ f: ['PE.13', 'GPIO:SYS_GPE_MFPH_PE13MFP_GPIO@GPE_MFPH', 'EBI_ADR15:SYS_GPE_MFPH_PE13MFP_EBI_ADR15@GPE_MFPH', 'I2C0_SCL:SYS_GPE_MFPH_PE13MFP_I2C0_SCL@GPE_MFPH', 'UART1_TXD:SYS_GPE_MFPH_PE13MFP_UART1_TXD@GPE_MFPH', 'PWM0_CH5:SYS_GPE_MFPH_PE13MFP_PWM0_CH5@GPE_MFPH', 'PWM1_CH0:SYS_GPE_MFPH_PE13MFP_PWM1_CH0@GPE_MFPH', 'BPWM1_CH5:SYS_GPE_MFPH_PE13MFP_BPWM1_CH5@GPE_MFPH'] },
	{ f: ['PE.14', 'GPIO:SYS_GPE_MFPH_PE14MFP_GPIO@GPE_MFPH', 'EBI_AD8:SYS_GPE_MFPH_PE14MFP_EBI_AD8@GPE_MFPH', 'UART2_TXD:SYS_GPE_MFPH_PE14MFP_UART2_TXD@GPE_MFPH', 'PSIO0_CH0:SYS_GPE_MFPH_PE14MFP_PSIO0_CH0@GPE_MFPH'] },
	{ f: ['PE.15', 'GPIO:SYS_GPE_MFPH_PE15MFP_GPIO@GPE_MFPH', 'EBI_AD9:SYS_GPE_MFPH_PE15MFP_EBI_AD9@GPE_MFPH', 'UART2_RXD:SYS_GPE_MFPH_PE15MFP_UART2_RXD@GPE_MFPH', 'PSIO0_CH1:SYS_GPE_MFPH_PE15MFP_PSIO0_CH1@GPE_MFPH'] },

	{ f: ['PF.0', 'GPIO:SYS_GPF_MFPL_PF0MFP_GPIO@GPF_MFPL', 'UART1_TXD:SYS_GPF_MFPL_PF0MFP_UART1_TXD@GPF_MFPL', 'I2C1_SCL:SYS_GPF_MFPL_PF0MFP_I2C1_SCL@GPF_MFPL', 'BPWM1_CH0:SYS_GPF_MFPL_PF0MFP_BPWM1_CH0@GPF_MFPL', 'ICE_DAT:SYS_GPF_MFPL_PF0MFP_ICE_DAT@GPF_MFPL', 'UART0_TXD:SYS_GPF_MFPL_PF0MFP_UART0_TXD@GPF_MFPL'] },
	{ f: ['PF.1', 'GPIO:SYS_GPF_MFPL_PF1MFP_GPIO@GPF_MFPL', 'UART1_RXD:SYS_GPF_MFPL_PF1MFP_UART1_RXD@GPF_MFPL', 'I2C1_SDA:SYS_GPF_MFPL_PF1MFP_I2C1_SDA@GPF_MFPL', 'BPWM1_CH1:SYS_GPF_MFPL_PF1MFP_BPWM1_CH1@GPF_MFPL', 'ICE_CLK:SYS_GPF_MFPL_PF1MFP_ICE_CLK@GPF_MFPL', 'UART0_RXD:SYS_GPF_MFPL_PF1MFP_UART0_RXD@GPF_MFPL'] },
...
NUTOOL_PIN.g_cfg_unusedGPIO = {
	"TSSOP20(4.4*6.5)(C_QSPI)": {
		"ALL": ["USB", "BPWM0", "BPWM1", "UART2" , "SPI0" , "USCI1" , "USCI2" , "TAMPER0" , "EBI" , "ACMP0" , "ACMP1" , "DAC0" , "OPA0" , "PSIO0"],
		"PARTIAL": ["I2C1_SMBAL", "I2C1_SMBSUS"],
	},
	"TSSOP28(4.4*9.7)(C_QSPI)": {
		"ALL": ["USB", "BPWM0", "BPWM1", "UART2" , "SPI0" , "USCI1" , "USCI2" , "TAMPER0" , "EBI" , "ACMP0" , "ACMP1" , "DAC0" , "OPA0" , "PSIO0"],
		"PARTIAL": ["I2C1_SMBAL", "I2C1_SMBSUS"],
	...
	"UTSSOP20(4.4*6.5)(C_QSPI)": {
		"ALL": ["BPWM0", "BPWM1", "UART2" , "SPI0" , "USCI1" , "USCI2" , "TAMPER0" , "EBI" , "ACMP0" , "ACMP1" , "DAC0" , "OPA0" , "PSIO0"],
		"PARTIAL": ["I2C1_SMBAL", "I2C1_SMBSUS"],
	},
	"UTSSOP28(4.4*9.7)(C_QSPI)": {
		"ALL": ["BPWM0", "BPWM1", "UART2" , "SPI0" , "USCI1" , "USCI2" , "TAMPER0" , "EBI" , "ACMP0" , "ACMP1" , "DAC0" , "OPA0" , "PSIO0"],
	...
	"M251ZD2AE(QFN33)": {
		"ALL": ["USB", "USCI2", "EBI", "DAC0", "OPA0"],
		"PARTIAL": ["PSIO0_CH4", "PSIO0_CH5", "PSIO0_CH6", "PSIO0_CH7"],
	},
	"M251LC2AE(LQFP48)": {
		"ALL": ["USB", "USCI2", "EBI", "DAC0", "OPA0"],
		"PARTIAL": ["PSIO0_CH4", "PSIO0_CH5", "PSIO0_CH6", "PSIO0_CH7"],
...
NUTOOL_PIN.decidepackageNumber = function (given_partNumber_package) {
	...
	case 'TSSOP20':
		...
		case "M251FC2AE":
		case "M251FB2AE":
			NUTOOL_PIN.g_packageNumberIndex = "TSSOP20(4.4*6.5)(C_QSPI)";
			break;
		default:
			NUTOOL_PIN.g_packageNumberIndex = "UTSSOP20(4.4*6.5)(C_QSPI)";
			break;
		}
		break;
	case 'TSSOP28':
		...
		case "M251EB2AE":
		case "M251EC2AE":
			NUTOOL_PIN.g_packageNumberIndex = "TSSOP28(4.4*9.7)(C_QSPI)";
			break;
		default:
			NUTOOL_PIN.g_packageNumberIndex = "UTSSOP28(4.4*9.7)(C_QSPI)";
			break;
		}
		break;
	case 'QFN33':
		...
		case "M251ZC2AE":
		case "M251ZD2AE":
			NUTOOL_PIN.g_packageNumberIndex = "QFN33(5*5)(C_D_QSPI)";
			break;
		default:
			NUTOOL_PIN.g_packageNumberIndex = "UQFN33(5*5)(C_D_QSPI)";
			break;
		}
		break;
	case 'LQFP48':
		...
		case "M251LE3AE":
		case "M251LG6AE":
			NUTOOL_PIN.g_packageNumberIndex = "LQFP48(7*7)(D_E_G_QSPI)";
			break;
		default:
			NUTOOL_PIN.g_packageNumberIndex = "ULQFP48(7*7)(D_E_G_QSPI)";
			break;
		}
		break;
	case 'LQFP64':
		...
		case "M251SD2AE":
		case "M251SC2AE":
			NUTOOL_PIN.g_packageNumberIndex = "LQFP64(7*7)(D_QSPI)";
			break;
		case "M252SD2AE":
		case "M252SC2AE":
			NUTOOL_PIN.g_packageNumberIndex = "ULQFP64(7*7)(D_QSPI)";
			break;
		case "M251SG6AE":
		case "M251SE3AE":
			NUTOOL_PIN.g_packageNumberIndex = "LQFP64(7*7)(E_G_QSPI)";
			break;
		default:
			NUTOOL_PIN.g_packageNumberIndex = "ULQFP64(7*7)(E_G_QSPI)";
			break;
		}
		break;
	case 'LQFP128':
		...
		case "M251KG6AE":
		case "M251KE3AE":
			NUTOOL_PIN.g_packageNumberIndex = "LQFP128(14*14)(E_G_QSPI)";
			break;
		default:
			NUTOOL_PIN.g_packageNumberIndex = "ULQFP128(14*14)(E_G_QSPI)";
			break;
		}
		break;
	}
