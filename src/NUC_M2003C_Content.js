...
NUTOOL_PIN.g_cfg_pkgs = {
    "TSSOP20(4.4)": [
        'PB.1', 'PB.2', 'PB.3', 'PE.15', 'PB.4', 
        'PB.5', 'VSS', 'PF.0', 'VDD', 'PC.14', 
        'PB.15', 'PB.14', 'PB.13', 'PB.12', 'PB.7', 
        'PB.8', 'PB.9', 'PF.1', 'PB.11', 'PB.0'
    ],
    "QFN20(AQ20)(3*3)": [
        'PB.3', 'PB.5', 'VSS', 'PF.0', 'VDD', 
        'PC.14', 'PB.7', 'PB.12', 'PB.13', 'PB.15', 
        'PB.14', 'PB.8', 'PB.9', 'PF.1', 'PB.11', 
        'PB.0', 'PB.4', 'PE.15', 'PB.2', 'PB.1'
    ],
    "QFN20(BQ20)(3*3)": [
        'PE.15', 'PB.4', 'PB.5', 'VSS', 'PF.0', 
        'VDD', 'PC.14', 'PB.15', 'PB.14', 'PB.13', 
        'PB.12', 'PB.7', 'PB.8', 'PB.9', 'PF.1', 
        'PB.11', 'PB.0', 'PB.1', 'PB.2', 'PB.3'
    ]
};
...
NUTOOL_PIN.g_cfg_gpios = [
    ...
    { f: ['PB.14:0', 'ADC0_ST:2', 'I2C0_SCL:3', 'USCI0_DAT1:5', 'UART0_nRTS:6', 'UART0_RXD:7', 'TM2_EXT:11', 'TM1_EXT:13', 'CLKO:14', 'PWM0_BRAKE1:15'] },
