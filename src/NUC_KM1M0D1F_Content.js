...
NUTOOL_PIN.g_cfg_gpios = [
    { f: ['P0.0:0', 'TM07IOB:1', 'TM10IOB:2', 'SIF1_SBI1A:4', 'LED_LED0:9']},
    { f: ['P0.1:0', 'TM08IOB:1', 'TM09IOB:2', 'SIF1_SBO1A:4', 'LED_LED1:9']},
    { f: ['P0.2:0', 'SIF1_SBT1A:4', 'LED_LED2:9']},
    { f: ['P0.3:0', 'TM00IOB:1', 'TM02IOB:2', 'TM15IOB:3', 'SIF1_SBC1A:4', 'LED_LED3:9']},
    { f: ['P0.4:0', 'TM11IOA:3', 'LED_LED4:9']},
    { f: ['P0.5:0', 'TM12IOA:3', 'SIF3_SBO3A:4', 'LED_LED5:9']},
    { f: ['P0.6:0', 'SIF3_SBI3A:4', 'LED_LED6:9']},
    { f: ['P0.7:0']},

    { f: ['P1.0:0', 'TM00IOC:1', 'TM15IOC:2', 'SIF4_SBC4B:4']},
    { f: ['P1.1:0']},
    { f: ['P1.2:0']},
    { f: ['P1.3:0']},
    { f: ['P1.4:0']},
    ...
    { f: ['P2.0:0', 'SIF3_SBT3A:4', 'SIF8_SCL8:5', 'DAC1_DA1OUT0:7', 'IRQ0A:10']},
    { f: ['P2.1:0', 'SIF3_SBC3A:4', 'SIF8_SDA8:5', 'IRQ1A:10']},
    { f: ['P2.2:0', 'IRQ2A:10']},
    ...
    { f: ['P4.6:0', 'SIF7_SDA7B:4']},
    { f: ['P4.7:0', 'SIF7_SCL7B:4']},

    { f: ['P5.0:0', 'TM07OUT0:1', 'SIF0_SBO0A:4', 'LIN_LTX0A:4', 'CMP1_CMPREF1B:8', 'KEY0:10']},
    { f: ['P5.1:0', 'TM07OUT1:1', 'SIF0_SBI0A:4', 'LIN_LRX0A:4', 'CMP1_CMPIN1B:8', 'KEY1:10']},
    { f: ['P5.2:0', 'TM07OUT2:1', 'SIF0_SBT0A:4', 'DAC1_DA1OUT1:7', 'KEY2:10']},
    { f: ['P5.3:0', 'TM07OUT3:1', 'BZ_BUZZERA:2', 'CMP1_CMPREF1A:8', 'KEY3:10']},
    { f: ['P5.4:0', 'TM07OUT4:1', 'BZ_NBUZZERA:2', 'CMP1_CMPIN1A:8', 'KEY4:10']},
    { f: ['P5.5:0', 'TM07OUT5:1', 'CMP1_CMPOT1:8', 'KEY5:10']},
    { f: ['P5.6:0', 'KEY6:10']},
    { f: ['P5.7:0', 'KEY7:10']},
    ...
    { f: ['P6.2:0', 'TM01IOB:1']},
    { f: ['P6.3:0', 'TM03IOB:1']},
    { f: ['P6.4:0', 'TM04IOB:1', 'SIF4_SBC4A:4']},
    { f: ['P6.5:0', 'SIF4_SBI4A:4']},
    { f: ['P6.6:0', 'SIF4_SBO4A:4', 'SIF6_SDA6A:5']},
    { f: ['P6.7:0', 'SIF4_SBT4A:4', 'SIF6_SCL6A:5']},

    { f: ['P7.0:0', 'SIF2_SBO2A:4']},
    { f: ['P7.1:0', 'SIF2_SBI2A:4']},
    { f: ['P7.2:0', 'SIF2_SBT2A:4']},
    { f: ['P7.3:0', 'TM13IOB:1', 'SIF2_SBC2A:4', 'SIF7_SDA7A:5']},
    { f: ['P7.4:0', 'TM14IOB:1', 'SIF1_SBC1B:4', 'SIF7_SCL7A:5']},
    { f: ['P7.5:0', 'SIF1_SBO1B:4']},
    { f: ['P7.6:0', 'SIF1_SBI1B:4']},
    ...
    { f: ['P9.2:0']},
    { f: ['P9.3:0']},
    { f: ['P9.4:0', 'DAC0_DA0OUT1:7', 'CMP0_CMPREF0B:8']},
    { f: ['P9.5:0']},
    { f: ['P9.6:0']},
    { f: ['P9.7:0']},
...
NUTOOL_PIN.g_cfg_gpiosDefines = [
    { f: ['P0.0', 'GPIO:GPIO_P00MD_GPIO@IOP0MD', 'TM07IOB:GPIO_P00MD_TM07IOB@IOP0MD', 'TM10IOB:GPIO_P00MD_TM10IOB@IOP0MD', 'SIF1_SBI1A:GPIO_P00MD_SBI1A@IOP0MD', 'LED_LED0:GPIO_P00MD_LED0@IOP0MD'] },
    { f: ['P0.1', 'GPIO:GPIO_P01MD_GPIO@IOP0MD', 'TM08IOB:GPIO_P01MD_TM08IOB@IOP0MD', 'TM09IOB:GPIO_P01MD_TM09IOB@IOP0MD', 'SIF1_SBO1A:GPIO_P01MD_SBO1A@IOP0MD', 'LED_LED1:GPIO_P01MD_LED1@IOP0MD'] },
    { f: ['P0.2', 'GPIO:GPIO_P02MD_GPIO@IOP0MD', 'SIF1_SBT1A:GPIO_P02MD_SBT1A@IOP0MD', 'LED_LED2:GPIO_P02MD_LED2@IOP0MD'] },
    { f: ['P0.3', 'GPIO:GPIO_P03MD_GPIO@IOP0MD', 'TM00IOB:GPIO_P03MD_TM00IOB@IOP0MD', 'TM02IOB:GPIO_P03MD_TM02IOB@IOP0MD', 'TM15IOB:GPIO_P03MD_TM15IOB@IOP0MD', 'SIF1_SBC1A:GPIO_P03MD_SBC1A@IOP0MD', 'LED_LED3:GPIO_P03MD_LED3@IOP0MD'] },
    { f: ['P0.4', 'GPIO:GPIO_P04MD_GPIO@IOP0MD', 'TM11IOA:GPIO_P04MD_TM11IOA@IOP0MD', 'LED_LED4:GPIO_P04MD_LED4@IOP0MD'] },
    ...
    { f: ['P1.0', 'GPIO:GPIO_P10MD_GPIO@IOP1MD', 'TM00IOC:GPIO_P10MD_TM00IOC@IOP1MD', 'TM15IOC:GPIO_P10MD_TM15IOC@IOP1MD', 'SIF4_SBC4B:GPIO_P10MD_SBC4B@IOP1MD'] },

    { f: ['P2.0', 'GPIO:GPIO_P20MD_GPIO@IOP2MD', 'SIF3_SBT3A:GPIO_P20MD_SBT3A@IOP2MD', 'SIF8_SCL8:GPIO_P20MD_SCL8@IOP2MD', 'DAC1_DA1OUT0:GPIO_P20MD_DA1OUT0@IOP2MD', 'IRQ0A:GPIO_P20MD_IRQ0A@IOP2MD'] },
    { f: ['P2.1', 'GPIO:GPIO_P21MD_GPIO@IOP2MD', 'SIF3_SBC3A:GPIO_P21MD_SBC3A@IOP2MD', 'SIF8_SDA8:GPIO_P21MD_SDA8@IOP2MD', 'IRQ1A:GPIO_P21MD_IRQ1A@IOP2MD'] },
    { f: ['P2.2', 'GPIO:GPIO_P22MD_GPIO@IOP2MD', 'IRQ2A:GPIO_P22MD_IRQ2A@IOP2MD'] },
    ...
    { f: ['P3.3', 'GPIO:GPIO_P33MD_GPIO@IOP3MD', 'SIF4_SBO4B:GPIO_P33MD_SBO4B@IOP3MD', 'SIF6_SDA6B:GPIO_P33MD_SDA6B@IOP3MD'] },
    { f: ['P3.4', 'GPIO:GPIO_P34MD_GPIO@IOP3MD', 'SIF4_SBT4B:GPIO_P34MD_SBT4B@IOP3MD', 'SIF6_SCL6B:GPIO_P34MD_SCL6B@IOP3MD'] },
    { f: ['P3.5', 'GPIO:GPIO_P35MD_GPIO@IOP3MD', 'SIF4_SBI4B:GPIO_P35MD_SBI4B@IOP3MD'] },
    ...
    { f: ['P4.6', 'GPIO:GPIO_P46MD_GPIO@IOP4MD', 'SIF7_SDA7B:GPIO_P46MD_SDA7B@IOP4MD'] },
    { f: ['P4.7', 'GPIO:GPIO_P47MD_GPIO@IOP4MD', 'SIF7_SCL7B:GPIO_P47MD_SCL7B@IOP4MD'] },

    { f: ['P5.0', 'GPIO:GPIO_P50MD_GPIO@IOP5MD', 'TM07OUT0:GPIO_P50MD_TM07OUT0@IOP5MD', 'SIF0_SBO0A:GPIO_P50MD_SBO0A@IOP5MD', 'LIN_LTX0A:GPIO_P50MD_LTX0A@IOP5MD', 'CMP1_CMPREF1B:GPIO_P50MD_CMPREF1B@IOP5MD', 'KEY0:GPIO_P50MD_KEY0@IOP5MD'] },
    { f: ['P5.1', 'GPIO:GPIO_P51MD_GPIO@IOP5MD', 'TM07OUT1:GPIO_P51MD_TM07OUT1@IOP5MD', 'SIF0_SBI0A:GPIO_P51MD_SBI0A@IOP5MD', 'LIN_LRX0A:GPIO_P51MD_LRX0A@IOP5MD', 'CMP1_CMPIN1B:GPIO_P51MD_CMPIN1B@IOP5MD', 'KEY1:GPIO_P51MD_KEY1@IOP5MD'] },
    { f: ['P5.2', 'GPIO:GPIO_P52MD_GPIO@IOP5MD', 'TM07OUT2:GPIO_P52MD_TM07OUT2@IOP5MD', 'SIF0_SBT0A:GPIO_P52MD_SBT0A@IOP5MD', 'DAC1_DA1OUT1:GPIO_P52MD_DA1OUT1@IOP5MD', 'KEY2:GPIO_P52MD_KEY2@IOP5MD'] },
    { f: ['P5.3', 'GPIO:GPIO_P53MD_GPIO@IOP5MD', 'TM07OUT3:GPIO_P53MD_TM07OUT3@IOP5MD', 'BZ_BUZZERA:GPIO_P53MD_BUZZERA@IOP5MD', 'CMP1_CMPREF1A:GPIO_P53MD_CMPREF1A@IOP5MD', 'KEY3:GPIO_P53MD_KEY3@IOP5MD'] },
    { f: ['P5.4', 'GPIO:GPIO_P54MD_GPIO@IOP5MD', 'TM07OUT4:GPIO_P54MD_TM07OUT4@IOP5MD', 'BZ_NBUZZERA:GPIO_P54MD_NBUZZERA@IOP5MD', 'CMP1_CMPIN1A:GPIO_P54MD_CMPIN1A@IOP5MD', 'KEY4:GPIO_P54MD_KEY4@IOP5MD'] },
    { f: ['P5.5', 'GPIO:GPIO_P55MD_GPIO@IOP5MD', 'TM07OUT5:GPIO_P55MD_TM07OUT5@IOP5MD', 'CMP1_CMPOT1:GPIO_P55MD_CMPOT1@IOP5MD', 'KEY5:GPIO_P55MD_KEY5@IOP5MD'] },
    { f: ['P5.6', 'GPIO:GPIO_P56MD_GPIO@IOP5MD', 'KEY6:GPIO_P56MD_KEY6@IOP5MD'] },
    { f: ['P5.7', 'GPIO:GPIO_P57MD_GPIO@IOP5MD', 'KEY7:GPIO_P57MD_KEY7@IOP5MD'] },

    { f: ['P6.1', 'GPIO:GPIO_P61MD_GPIO@IOP6MD'] },
    { f: ['P6.2', 'GPIO:GPIO_P62MD_GPIO@IOP6MD', 'TM01IOB:GPIO_P62MD_TM01IOB@IOP6MD'] },
    { f: ['P6.3', 'GPIO:GPIO_P63MD_GPIO@IOP6MD', 'TM03IOB:GPIO_P63MD_TM03IOB@IOP6MD'] },
    { f: ['P6.4', 'GPIO:GPIO_P64MD_GPIO@IOP6MD', 'TM04IOB:GPIO_P64MD_TM04IOB@IOP6MD', 'SIF4_SBC4A:GPIO_P64MD_SBC4A@IOP6MD'] },
    { f: ['P6.5', 'GPIO:GPIO_P65MD_GPIO@IOP6MD', 'SIF4_SBI4A:GPIO_P65MD_SBI4A@IOP6MD'] },
    { f: ['P6.6', 'GPIO:GPIO_P66MD_GPIO@IOP6MD', 'SIF4_SBO4A:GPIO_P66MD_SBO4A@IOP6MD', 'SIF6_SDA6A:GPIO_P66MD_SDA6A@IOP6MD'] },
    { f: ['P6.7', 'GPIO:GPIO_P67MD_GPIO@IOP6MD', 'SIF4_SBT4A:GPIO_P67MD_SBT4A@IOP6MD', 'SIF6_SCL6A:GPIO_P67MD_SCL6A@IOP6MD'] },

    { f: ['P7.0', 'GPIO:GPIO_P70MD_GPIO@IOP7MD', 'SIF2_SBO2A:GPIO_P70MD_SBO2A@IOP7MD'] },
    { f: ['P7.1', 'GPIO:GPIO_P71MD_GPIO@IOP7MD', 'SIF2_SBI2A:GPIO_P71MD_SBI2A@IOP7MD'] },
    { f: ['P7.2', 'GPIO:GPIO_P72MD_GPIO@IOP7MD', 'SIF2_SBT2A:GPIO_P72MD_SBT2A@IOP7MD'] },
    { f: ['P7.3', 'GPIO:GPIO_P73MD_GPIO@IOP7MD', 'TM13IOB:GPIO_P73MD_TM13IOB@IOP7MD', 'SIF2_SBC2A:GPIO_P73MD_SBC2A@IOP7MD', 'SIF7_SDA7A:GPIO_P73MD_SDA7A@IOP7MD'] },
    { f: ['P7.4', 'GPIO:GPIO_P74MD_GPIO@IOP7MD', 'TM14IOB:GPIO_P74MD_TM14IOB@IOP7MD', 'SIF1_SBC1B:GPIO_P74MD_SBC1B@IOP7MD', 'SIF7_SCL7A:GPIO_P74MD_SCL7A@IOP7MD'] },
    { f: ['P7.5', 'GPIO:GPIO_P75MD_GPIO@IOP7MD', 'SIF1_SBO1B:GPIO_P75MD_SBO1B@IOP7MD'] },
    { f: ['P7.6', 'GPIO:GPIO_P76MD_GPIO@IOP7MD', 'SIF1_SBI1B:GPIO_P76MD_SBI1B@IOP7MD'] },
    { f: ['P7.7', 'GPIO:GPIO_P77MD_GPIO@IOP7MD', 'SIF1_SBT1B:GPIO_P77MD_SBT1B@IOP7MD'] },

    { f: ['P8.0', 'GPIO:GPIO_P80MD_GPIO@IOP8MD', 'SDO0:GPIO_P80MD_SDO0@IOP8MD', 'PWM0_PWM0A:GPIO_P80MD_PWM0A@IOP8MD'] },
    ...
    { f: ['P8.5', 'GPIO:GPIO_P85MD_GPIO@IOP8MD', 'SDO5:GPIO_P85MD_SDO5@IOP8MD', 'PWM0_NPWM2A:GPIO_P85MD_NPWM2A@IOP8MD', 'DAC0_DA0OUT0:GPIO_P85MD_DA0OUT0@IOP8MD'] },
    { f: ['P8.6', 'GPIO:GPIO_P86MD_GPIO@IOP8MD', 'SDO6:GPIO_P86MD_SDO6@IOP8MD', 'PWM0_PWMBCSTA:GPIO_P86MD_PWMBCSTA@IOP8MD'] },
    { f: ['P8.7', 'GPIO:GPIO_P87MD_GPIO@IOP8MD', 'SDO7:GPIO_P87MD_SDO7@IOP8MD'] },

    { f: ['P9.0', 'GPIO:GPIO_P90MD_GPIO@IOP9MD', 'XO:GPIO_P90MD_XO@IOP9MD'] },
    { f: ['P9.1', 'GPIO:GPIO_P91MD_GPIO@IOP9MD', 'XI:GPIO_P91MD_XI@IOP9MD'] },
    { f: ['P9.2', 'GPIO:GPIO_P92MD_GPIO@IOP9MD'] },
    { f: ['P9.3', 'GPIO:GPIO_P93MD_GPIO@IOP9MD'] },
    { f: ['P9.4', 'GPIO:GPIO_P94MD_GPIO@IOP9MD', 'DAC0_DA0OUT1:GPIO_P94MD_DA0OUT1@IOP9MD', 'CMP0_CMPREF0B:GPIO_P94MD_CMPREF0B@IOP9MD'] },
    { f: ['P9.5', 'GPIO:GPIO_P95MD_GPIO@IOP9MD'] },

    { f: ['PA.0', 'GPIO:GPIO_PA0MD_GPIO@IOPAMD', 'TM00IOA:GPIO_PA0MD_TM00IOA@IOPAMD', 'TM15IOA:GPIO_PA0MD_TM15IOA@IOPAMD', 'AN0:GPIO_PA0MD_AN0@IOPAMD'] },
    { f: ['PA.1', 'GPIO:GPIO_PA1MD_GPIO@IOPAMD', 'TM01IOA:GPIO_PA1MD_TM01IOA@IOPAMD', 'TM11IOB:GPIO_PA1MD_TM11IOB@IOPAMD', 'AN1:GPIO_PA1MD_AN1@IOPAMD'] },
    { f: ['PA.2', 'GPIO:GPIO_PA2MD_GPIO@IOPAMD', 'TM02IOA:GPIO_PA2MD_TM02IOA@IOPAMD', 'TM12IOB:GPIO_PA2MD_TM12IOB@IOPAMD', 'AN2:GPIO_PA2MD_AN2@IOPAMD'] },
    { f: ['PA.3', 'GPIO:GPIO_PA3MD_GPIO@IOPAMD', 'TM03IOA:GPIO_PA3MD_TM03IOA@IOPAMD', 'AN3:GPIO_PA3MD_AN3@IOPAMD'] },
