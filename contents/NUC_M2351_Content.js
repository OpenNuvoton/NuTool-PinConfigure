...
NUTOOL_PIN.g_cfg_pkgs = {
    ...
    "WLCSP49(USB1.1)(3.2*3.2)": [
        'nRESET', 'PF.0', 'PC.0', 'PC.1', 'PA.15', 'PA.13', 'PA.14', 
        'PA.2', 'PA.0', 'PF.1', 'PB.14', 'PB.15', 'PA.12', 'Vsw', 
        'PA.4', 'PA.1', 'PA.6', 'PB.9', 'PB.11', 'LDO_CAP', 'VSS', 
        'PA.7', 'PA.3', 'PA.8', 'PB.8', 'PB.10', 'PB.12', 'VDD', 
        'PC.7', 'PC.6', 'PD.12', 'PB.5', 'PB.6', 'AVDD', 'PB.13', 
        'PF.2', 'PD.10', 'PD.11', 'PB.2', 'PB.4', 'VREF', 'AVSS', 
        'PF.3', 'PF.4', 'PF.5', 'PB.1', 'PB.0', 'PB.3', 'PB.7'
    ],
	"LQFP64(7*7)": [
...
NUTOOL_PIN.g_cfg_gpios = [
    ...
    { f: ['PE.8:0', 'EBI_ADR10:2', 'I2S0_BCLK:4', 'SPI2_CLK:5', 'USCI1_CTL1:6', 'UART2_TXD:7', 'EPWM0_CH0:10', 'EPWM0_BRAKE0:11', 'ECAP0_IC0:12', 'TRACE_CLK:14']},
    { f: ['PE.9:0', 'EBI_ADR11:2', 'I2S0_MCLK:4', 'SPI2_MISO:5', 'USCI1_CTL0:6', 'UART2_RXD:7', 'EPWM0_CH1:10', 'EPWM0_BRAKE1:11', 'ECAP0_IC1:12', 'TRACE_DATA0:14']},
    ...
    { f: ['PE.11:0', 'EBI_ADR13:2', 'I2S0_DO:4', 'SPI2_SS:5', 'USCI1_DAT1:6', 'UART3_RXD:7', 'UART1_nCTS:8', 'EPWM0_CH3:10', 'EPWM1_BRAKE1:11', 'ECAP1_IC2:13', 'TRACE_DATA2:14']},
    { f: ['PE.12:0', 'EBI_ADR14:2', 'I2S0_LRCK:4', 'SPI2_I2SMCLK:5', 'USCI1_CLK:6', 'UART1_nRTS:8', 'EPWM0_CH4:10', 'ECAP1_IC1:13', 'TRACE_DATA3:14']},
...
NUTOOL_PIN.g_cfg_gpiosDefines = [
    ...
    { f: ['PE.11', 'GPIO:SYS_GPE_MFPH_PE11MFP_GPIO@GPE_MFPH', 'EBI_ADR13:SYS_GPE_MFPH_PE11MFP_EBI_ADR13@GPE_MFPH', 'I2S0_DO:SYS_GPE_MFPH_PE11MFP_I2S0_DO@GPE_MFPH', 'SPI2_SS:SYS_GPE_MFPH_PE11MFP_SPI2_SS@GPE_MFPH', 'USCI1_DAT1:SYS_GPE_MFPH_PE11MFP_USCI1_DAT1@GPE_MFPH', 'UART3_RXD:SYS_GPE_MFPH_PE11MFP_UART3_RXD@GPE_MFPH', 'UART1_nCTS:SYS_GPE_MFPH_PE11MFP_UART1_nCTS@GPE_MFPH', 'EPWM0_CH3:SYS_GPE_MFPH_PE11MFP_EPWM0_CH3@GPE_MFPH', 'EPWM1_BRAKE1:SYS_GPE_MFPH_PE11MFP_EPWM1_BRAKE1@GPE_MFPH', 'ECAP1_IC2:SYS_GPE_MFPH_PE11MFP_ECAP1_IC2@GPE_MFPH', 'TRACE_DATA2:SYS_GPE_MFPH_PE11MFP_TRACE_DATA2@GPE_MFPH'] },
    { f: ['PE.12', 'GPIO:SYS_GPE_MFPH_PE12MFP_GPIO@GPE_MFPH', 'EBI_ADR14:SYS_GPE_MFPH_PE12MFP_EBI_ADR14@GPE_MFPH', 'I2S0_LRCK:SYS_GPE_MFPH_PE12MFP_I2S0_LRCK@GPE_MFPH', 'SPI2_I2SMCLK:SYS_GPE_MFPH_PE12MFP_SPI2_I2SMCLK@GPE_MFPH', 'USCI1_CLK:SYS_GPE_MFPH_PE12MFP_USCI1_CLK@GPE_MFPH', 'UART1_nRTS:SYS_GPE_MFPH_PE12MFP_UART1_nRTS@GPE_MFPH', 'EPWM0_CH4:SYS_GPE_MFPH_PE12MFP_EPWM0_CH4@GPE_MFPH', 'ECAP1_IC1:SYS_GPE_MFPH_PE12MFP_ECAP1_IC1@GPE_MFPH', 'TRACE_DATA3:SYS_GPE_MFPH_PE8MFP_TRACE_DATA3@GPE_MFPH'] },
...
NUTOOL_PIN.g_cfg_unusedGPIO = {
    ...
    "WLCSP49(USB1.1)(3.2*3.2)": {
        "ALL": ["ECAP1", "ETM", "SWDH", "TAMPER", "SPI3"]
    },
	"LQFP64(USB1.1)(7*7)": {
		"ALL": ["ECAP1", "ETM", "SWDH"]
	},
...
NUTOOL_PIN.decidepackageNumber = function (given_partNumber_package) {
	...
	case 'QFN33':
		...
		break;
    case 'WLCSP49':
        NUTOOL_PIN.g_packageNumberIndex = "WLCSP49(USB1.1)(3.2*3.2)";
        break;
	case 'LQFP64':
