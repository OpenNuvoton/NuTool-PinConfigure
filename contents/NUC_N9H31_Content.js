...
NUTOOL_PIN.g_cfg_pkgs = {
    "LQFP128(14*14)": [
        ...
        'PI.11', 'PI.12', 'PI.13', 'IO_VSS', 'PI.14', 'PI.15', 'IO_VDD', 'PB.6', 'PB.7', 'PB.8', 
        'PB.9', 'PB.10', 'PB.11', 'PB.12', 'PB.13', 'PJ.3', 'PJ.0', 'PJ.1', 'PJ.2', 'PJ.4', 
        'nRESET', 'CORE_VDD', 'DDR_VDD', 'DDR_VDD', 'IO_VDD', 'PD.0', 'PD.1', 'PD.2', 'PD.3', 'PD.4', 
        'PD.5', 'PD.6', 'PD.7', 'PLL_VDD', 'PLL_VSS', 'PH.3', 'PH.2', 'PE.13', 'PE.12', 'PE.1', 
        'PE.0', 'IO_VDD', 'XT1_IN', 'XT1_OUT', 'PF.9', 'PF.8', 'PF.7', 'PF.6', 'PF.5', 'PF.4', 
        'PF.3', 'PF.2', 'PF.1', 'PF.0', 'PH.1', 'PH.0', 'PF.10', 'USBPLL1_VDD', 'USB1_DM', 'USB1_DP', 
        'USB1_VDD', 'USB1_REXT', 'USBPLL0_VDD', 'USB0_DM', 'USB0_DP', 'USB0_VDD', 'USB0_REXT', 'IO_VSS'
    ]
};
...
NUTOOL_PIN.g_cfg_gpios = [
    ...
    { f: ['PB.6:0', 'SPI0_SS0:2']},
    { f: ['PB.7:0', 'SPI0_CLK:2']},
    { f: ['PB.8:0', 'SPI0_DO:2', 'SPI0_DATA0:2']},
    { f: ['PB.9:0', 'SPI0_DI:2', 'SPI0_DATA1:2']},
    ...
    { f: ['PD.6:0', 'SD0_nCD:1']},
    { f: ['PD.7:0']},
    { f: ['PD.8:0', 'LCD_DATA16:1']},
    { f: ['PD.9:0', 'LCD_DATA17:1']},
    { f: ['PD.10:0', 'LCD_DATA18:1']},
    { f: ['PD.11:0', 'LCD_DATA19:1', 'UART9_TXD:4']},
    { f: ['PD.12:0', 'LCD_DATA20:1', 'PWM0:3', 'UART9_RXD:4']},
    { f: ['PD.13:0', 'LCD_DATA21:1', 'PWM1:3']},
    { f: ['PD.14:0', 'LCD_DATA22:1', 'PWM2:3', 'UART9_TXD:4']},
    { f: ['PD.15:0', 'LCD_DATA23:1', 'PWM3:3', 'UART9_RXD:4']},
    ...
    { f: ['PE.13:0', 'UART3_RXD:2', 'UART8_CTS:6', 'CLK_OUT:8']},
    { f: ['PE.14:0']},
    { f: ['PE.15:0']},
    ...
    { f: ['PI.0:0']},
    { f: ['PI.1:0', 'NAND_nCS0:2', 'UART7_TXD:3', 'INT6:4']},
    { f: ['PI.2:0']},
    { f: ['PI.3:0', 'I2C1_SCL:1', 'NAND_ALE:2', 'VCAP_CLKO:4', 'CAN0_RXD:5']},
    { f: ['PI.4:0', 'I2C1_SDA:1', 'NAND_CLE:2', 'VCAP_PCLK:4', 'CAN0_TXD:5']},
    { f: ['PI.5:0', 'NAND_nWE:2', 'UART1_TXD:3', 'VCAP_HSYNC:4', 'SPI1_SS0:5', 'SD1_CMD:6', 'eMMC_CMD:7']},
    { f: ['PI.6:0', 'SC1_RST:1', 'NAND_nRE:2', 'UART1_RXD:3', 'VCAP_VSYNC:4', 'SPI1_CLK:5', 'SD1_CLK:6', 'eMMC_CLK:7']},
    { f: ['PI.7:0', 'SC1_CLK:1', 'NAND_RDY0:2', 'UART1_RTS:3', 'VCAP_FIELD:4', 'SPI1_DO:5', 'SPI1_DATA0:5', 'SD1_DAT0:6', 'eMMC_DATA3:7']},
    { f: ['PI.8:0', 'SC1_DAT:1', 'NAND_DATA0:2', 'UART1_CTS:3', 'VCAP_DATA0:4', 'SPI1_DI:5', 'SPI1_DATA1:5', 'SD1_DAT1:6', 'eMMC_DATA0:7']},
    { f: ['PI.9:0', 'SC1_PWR:1', 'NAND_DATA1:2', 'UART4_TXD:3', 'VCAP_DATA1:4', 'SD1_DAT2:6', 'eMMC_DATA1:7']},
    { f: ['PI.10:0', 'SC1_CD:1', 'NAND_DATA2:2', 'UART4_RXD:3', 'VCAP_DATA2:4', 'SD1_DAT3:6', 'eMMC_DATA2:7']},
    { f: ['PI.11:0', 'SC0_RST:1', 'NAND_DATA3:2', 'VCAP_DATA3:4']},
    { f: ['PI.12:0', 'SC0_CLK:1', 'NAND_DATA4:2', 'UART8_TXD:3', 'VCAP_DATA4:4', 'SD1_nCD:6']},
    { f: ['PI.13:0', 'SC0_DAT:1', 'NAND_DATA5:2', 'UART8_RXD:3', 'VCAP_DATA5:4', 'SD1_nPWR:6']},
    { f: ['PI.14:0', 'SC0_PWR:1', 'NAND_DATA6:2', 'UART8_RTS:3', 'VCAP_DATA6:4']},
    { f: ['PI.15:0', 'SC0_CD:1', 'NAND_DATA7:2', 'UART8_CTS:3', 'VCAP_DATA7:4', 'CLK_OUT:9']},
