Attribute VB_Name = "ParseMultiFunctionDescriptions"
Option Explicit
Option Base 1
...
Sub packageGPIOParsing()
    ...
    sResult = ParseMultiFunctionDescriptions
    printToTxtFile (sResult)
End Sub

Function ParseMultiFunctionDescriptions() As String
    Dim ii As Integer
    Dim ij As Integer
    Dim ik As Integer
    Dim iz As Integer
...
'    sEndColumnForPackage = "C"
    ...
    sOutputResult = "NUTOOL_PIN.g_cfg_gpiosDescriptions = [" & vbCrLf
    ...
    ParseMultiFunctionDescriptions = sOutputResult
